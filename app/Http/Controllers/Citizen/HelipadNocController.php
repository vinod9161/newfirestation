...
class HelipadNocController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('citizen.temporary..helipad.helipad', compact('districts','tehsil','block','panchayat'));
            
    }
    public function addHelipadBasicDetails(Request $request)
    {
        ...
        $result = $this->commonModel->insertData('temp_helipad_applications', $data);
        if ($result == 1)
        {
    ...
    public function addHelipadApplicantDetails(Request $request)
    {
        ...
        elseif ($request->rural_urban == 'rural')
        {
        ...
        $result = $this->commonModel->updateDataByOneCondition('temp_helipad_applications', ['application_no' => $request->application_no], $data);
        if ($result == 1)
        {
    ...
    public function addHelipadOrganizingDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $organizing_address = [];
    ...
    public function addHelipadOrganizerDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addHelipadErectorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addHelipadCoordinatorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addHelipadProjectDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $project_area_detail = [];
        $project_area_detail['project_type'] = $request->project_type;
        $project_area_detail['helipad_type'] = $request->helipad_type;
        $project_area_detail['air_strip_type'] = $request->air_strip_type;
        $project_area_detail['capacity'] = $request->capacity;
        $project_area_detail['sitting_capacity'] = $request->sitting_capacity;
        ...
        $project_area_detail['fuel_storage'] = $request->fuel_storage;
        $project_area_detail['separate_road'] = $request->separate_road;
        $project_area_detail['other_comment'] = $request->other_comment;
        $data = [
    ...
    public function addHelipadAttachmentsDetails(Request $request)
    {
        $reference_letter = '';
        $fire_plan = '';
