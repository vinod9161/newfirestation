...
class FilmShootingNocController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('citizen.temporary.film_shooting.film_shooting', compact('districts','tehsil','block','panchayat'));
            
    }
    public function addFilmShootingBasicDetails(Request $request)
    {
        ...
        $data = [
            ...
            'user_id' => $user_id,
            'noc_type' => 'film-shooting',
            'applicant_type' => $request->applicant_type,
            'status' => 'pending',
        ];
        $result = $this->commonModel->insertData('temp_film_shooting_applications', $data);
        if ($result == 1)
        {
    ...
    public function addFilmShootingApplicantDetails(Request $request)
    {
        ...
        $result = $this->commonModel->updateDataByOneCondition('temp_film_shooting_applications', ['application_no' => $request->application_no], $data);
        if ($result == 1)
        {
    ...
    public function addFilmShootingOrganizingDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $organizing_address = [];
    ...
    public function addFilmShootingOrganizerDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addFilmShootingErectorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addFilmShootingCoordinatorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addFilmShootingProjectDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $project_area_detail = [];
    ...
    public function addFilmShootingAttachmentsDetails(Request $request)
    {
        $reference_letter = '';
        $route_plan = '';
        $fire_plan = '';
