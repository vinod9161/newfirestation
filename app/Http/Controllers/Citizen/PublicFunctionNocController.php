...
class PublicFunctionNocController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('citizen.temporary.function.public_function', compact('districts','tehsil','block','panchayat'));
    }
    public function addPublicFunctionBasicDetails(Request $request)
    {
        ...
        $data = [
            ...
            'user_id' => $user_id,
            'noc_type' => 'public-function',
            'applicant_type' => $request->applicant_type,
            'status' => 'pending'
        ];
        $result = $this->commonModel->insertData('temp_public_function_applications', $data);
        if ($result == 1)
        {
    ...
    public function addPublicFunctionApplicantDetails(Request $request)
    {
        $request->validate([
        ...
        $result = $this->commonModel->updateDataByOneCondition('temp_public_function_applications', ['application_no' => $request->application_no], $data);
        if ($result == 1)
        {
    ...
    public function addPublicFunctionOrganizingDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $organizing_address = [];
    ...
    public function addPublicFunctionOrganizerDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addPublicFunctionErectorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addPublicFunctionCoordinatorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addPublicFunctionProjectDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $project_area_detail = [];
    ...
    public function addPublicFunctionAttachmentsDetails(Request $request)
    {
        $reference_letter = '';
        $route_plan = '';
        $fire_plan = '';
