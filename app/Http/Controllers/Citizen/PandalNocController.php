...
class PandalNocController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('citizen.temporary.pandal.pandal', compact('districts', 'tehsil', 'block', 'panchayat'));
    }
    public function addPandalBasicDetails(Request $request)
    {
    ...
    public function addPandalApplicantDetails(Request $request)
    {
        ...
        $result = $this->commonModel->updateDataByOneCondition('temp_pandal_applications', ['application_no' => $request->application_no], $data);
        if ($result == 1)
        {
    ...
    public function addPandalOrganizingDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $organizing_address = [];
    ...
    public function addPandalOrganizerDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addPandalErectorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addPandalCoordinatorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addPandalProjectDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $project_area_detail = [];
    ...
    public function addPandalAttachmentsDetails(Request $request)
    {
        $reference_letter = '';
        $route_plan = '';
        $fire_plan = '';
