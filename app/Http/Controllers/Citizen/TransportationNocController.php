...
class TransportationNocController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('citizen.temporary..transportation.transportation', compact('districts','tehsil','block','panchayat'));
            
    }
    public function addTransportationBasicDetails(Request $request)
    {
        ...
        $data = [
            ...
            'user_id' => $user_id,
            'noc_type' => 'transportation',
            'applicant_type' => $request->applicant_type,
            'status' => 'pending',
        ];
        $result = $this->commonModel->insertData('temp_transportation_applications', $data);
        if ($result == 1)
        {
    ...
    public function addTransportationApplicantDetails(Request $request)
    {
        ...
        $result = $this->commonModel->updateDataByOneCondition('temp_transportation_applications', ['application_no' => $request->application_no], $data);
        if ($result == 1)
        {
    ...
    public function addTransportationOrganizingDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $organizing_address = [];
    ...
    public function addTransportationOrganizerDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addTransportationErectorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addTransportationCoordinatorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addTransportationProjectDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $project_area_detail = [];

        $project_area_detail['total_plot_area'] = $request->total_plot_area;
        $project_area_detail['mode_of_transport'] = $request->mode_of_transport;
        $project_area_detail['means_of_transport'] = $request->means_of_transport;
        $project_area_detail['no_of_transport'] = $request->no_of_transport;
        $project_area_detail['name_of_hazardous_material'] = $request->name_of_hazardous_material;
        $project_area_detail['category_of_hazardous_material'] = $request->category_of_hazardous_material;
        $project_area_detail['capacity_of_hazardous_material'] = $request->capacity_of_hazardous_material;
        $project_area_detail['no_of_person'] = $request->no_of_person;
        $project_area_detail['expected_date'] = $request->expected_date;
        $project_area_detail['expected_time'] = $request->expected_time;
        $project_area_detail['route_transportation'] = $request->route_transportation;
        $data = [
    ...
    public function addTransportationAttachmentsDetails(Request $request)
    {
        $reference_letter = '';
        $route_plan = '';
        $fire_plan = '';
