...
class EntertainmentActivityNocController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('citizen.temporary.entertainment_activity.entertainment_activity', compact('districts','tehsil','block','panchayat')); 
    }
    
    public function addEntertainmentBasicDetails(Request $request)
    {
        ...
        $data = [
            ...
            'user_id' => $user_id,
            'noc_type' => 'entertainment-activity',
            'applicant_type' => $request->applicant_type,
            'status' => 'pending'
        ];
        $result = $this->commonModel->insertData('temp_entertainment_activity_applications', $data);
        if ($result == 1)
        {
    ...
    public function addEntertainmentApplicantDetails(Request $request)
    {
        ...
        $result = $this->commonModel->updateDataByOneCondition('temp_entertainment_activity_applications', ['application_no' => $request->application_no], $data);
        if ($result == 1)
        {
    ...
    public function addEntertainmentOrganizingDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $organizing_address = [];
    ...
    public function addEntertainmentOrganizerDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addEntertainmentErectorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addEntertainmentCoordinatorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addEntertainmentProjectDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $project_area_detail = [];
    ...
    public function addEntertainmentAttachmentsDetails(Request $request)
    {
        $reference_letter = '';
        $fire_plan = '';
