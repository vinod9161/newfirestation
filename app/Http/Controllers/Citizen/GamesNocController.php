...
class GamesNocController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('citizen.temporary.games.games', compact('districts','tehsil','block','panchayat'));
            
    }
    public function addGamesBasicDetails(Request $request)
    {
        ...
        $result = $this->commonModel->insertData('temp_games_applications', $data);
        if ($result == 1)
        {
    ...
    public function addGamesApplicantDetails(Request $request)
    {
        ...
        $result = $this->commonModel->updateDataByOneCondition('temp_games_applications', ['application_no' => $request->application_no], $data);
        if ($result == 1)
        {
    ...
    public function addGamesOrganizingDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $organizing_address = [];
    ...
    public function addGamesOrganizerDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addGamesErectorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addGamesCoordinatorDetails(Request $request)
    {
        $user_id = Auth::user()->id;
    ...
    public function addGamesProjectDetails(Request $request)
    {
        $user_id = Auth::user()->id;
        $project_area_detail = [];
        ...
        $project_area_detail['sport_type'] = $request->sport_type;
    ...
    public function addGamesAttachmentsDetails(Request $request)
    {
        $reference_letter = '';
        $fire_plan = '';
