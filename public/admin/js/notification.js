(function () {
	...
	document.querySelector('#popup').addEventListener('click', function () {
		notifier.modal(`<h3 class="fw-semibold mb-1 text-default fs-16">Welcome To Dashlead Admin Template </h3><small class="text-sm">Click outside the modal window to close it.</small>`, 'demo')
	})
