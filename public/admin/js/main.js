(function () {
    ...
    if (localStorage.getItem("dashleadlayout") == "horizontal") {
      document
        .querySelector("html")
    ...
    function localStorageBackup() {
      ...
      if (localStorage.dashleadverticalstyles) {
        ...
        if (verticalStyles == "default") {
          ...
          localStorage.removeItem("dashleadnavstyles");
        }
          ...
          setTimeout(() => {
            ...
            menuSlideItem.forEach((e) => {
              ...
              e.addEventListener("mouseenter", () => {
                if (localStorage.dashleadverticalstyles == "doublemenu") {
      ...
      if (localStorage.dashleadnavstyles) {
        let html = document.querySelector("html");
        let navStyles = localStorage.getItem("dashleadnavstyles");
      ...
      if (localStorage.dashleadclassic) {
        let html = document.querySelector("html");
        html.setAttribute("data-page-style", "classic");
      }
      if (localStorage.dashleadmodern) {
        let html = document.querySelector("html");
      ...
      if (localStorage.dashleadheaderfixed) {
        let html = document.querySelector("html");
        html.setAttribute("data-header-position", "fixed");
      }
      if (localStorage.dashleadheaderscrollable) {
        let html = document.querySelector("html");
        html.setAttribute("data-header-position", "scrollable");
      }
      if (localStorage.dashleadmenufixed) {
        let html = document.querySelector("html");
        html.setAttribute("data-menu-position", "fixed");
      }
      if (localStorage.dashleadmenuscrollable) {
        let html = document.querySelector("html");
