(function () {
    ...
    var chart = new ApexCharts(
      document.querySelector("#timeline-colors"),
      options
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#timeline-multi"),
      options
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#timeline-advanced"),
      options
    );
    chart.render();
    ...
    var chart = new ApexCharts(
      document.querySelector("#timeline-grouped"),
      options
    );
    chart.render();
  })();