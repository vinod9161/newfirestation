...
Route::resource('personnel-expense', App\Http\Controllers\Admin\PersonnelExpenseController::class);
Route::prefix('admin')->group(function () {
    Route::get('report-fee-master', [ReportFeeMasterController::class, 'index'])->name('report-fee-master.index');
    Route::get('report-fee-master/edit/{id}', [ReportFeeMasterController::class, 'edit'])->name('report-fee-master.edit');
    Route::post('report-fee-master/update/{id}', [ReportFeeMasterController::class, 'update'])->name('report-fee-master.update');
});
