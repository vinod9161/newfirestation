            ...
            <div class="col-lg-12">
              <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                ...
                <div class="form-group">
                  <textarea class="form-control" name="Feedback/Suggestions" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Feedback/Suggestions"></textarea>
                  <div class="validate"></div>
                </div>
                <div class="mb-3">
