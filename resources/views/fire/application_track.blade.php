...
<section class="breadcrumb-section">
	...
	<div class="breadcrumb-content">
		<h1 class="breadcrumb-item">Application Status</h1>
                    ...
                    if(res.status == 0){
                        ...
                        let html = "";
                            ...
                            history.forEach(item => {
                                let historyText = item.history
                                    .replace(/\bSubmitted\b/g, "submitted")
                                    .replace(/\bSent\b/g, "sent")
                                    .replace(/\bPre\b/g, "pre")
                                    .replace(/\bApproved\b/g, "approved")
                                    .replace(/\bSuccessfully\b/g, "successfully")
                                    .replace(/\.{2,}!/g, "")
                                    .replace(/\.{2,}/g, "")
                                    .trim();
                                ...
                                html += `
                                    <li class="timeline-item">
                                        ...
                                        <p class="timeline-text">${historyText}</p>
                                    </li>
                                `;
                            });
