...
<section class="breadcrumb-section">
  <div class="overlay"></div>
    ...
    <h1 class="breadcrumb-item">Academy Training Schedule</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('actionIndex') }}">Home <i class="fa fa-angle-double-right"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Academy <i class="fa fa-angle-double-right"></i></a> </li>
        <li class="breadcrumb-item active" aria-current="page">Academy Training Schedule</li>
        </ol>
    </nav>
  </div>
</section>
...
<div class="container" style="margin-bottom: 40px;">
   <div class="row">
      <div class="col-md-12">
         <h3 style="margin-top: 40px;"><h2>Academy Training Schedule</h2></h3>
            ...
            <table class="table table-bordered table-responsive-sm">
               <thead>
                  <tr>
                     ...
                     <th scope="col">Training Schedule Name</th>
                     <th scope="col">Training Schedule File </th>
                  </tr>
               </thead>
               <tbody>
