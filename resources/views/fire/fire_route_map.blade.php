...
<section class="breadcrumb-section">
  <div class="overlay"></div>
    ...
    <h1 class="breadcrumb-item">Academy Route Map</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('actionIndex') }}">Home <i class="fa fa-angle-double-right"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Academy <i class="fa fa-angle-double-right"></i></a> </li>
        <li class="breadcrumb-item active" aria-current="page">Academy Route Map</li>
        </ol>
    </nav>
  </div>
</section>
...
<div class="container" style="margin-bottom: 40px;">
   <div class="row">
      <div class="col-md-12">
         <h3 style="margin-top: 40px;"><h2>Academy Route Map</h2></h3>
            ...
            <table class="table table-bordered table-responsive-sm">
               <thead>
                  <tr>
                     ...
                     <th scope="col">Route Map Name</th>
                     <th scope="col">Route Map File </th>
                  </tr>
               </thead>
               <tbody>
