   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-12 d-flex flex-column justify-content-center p-5">
            <h4 class="title">Fire / Rescue / Other Incident Report</a></h4>
            <p class="description"> fire incident report can be obtained by the person after deposit a required fee. 
            </p>
         </div>
      </div>
   </div>
...
<div class="header-page" style="overflow-x: hidden;">
   <!-- <div class="row">
      <div class="col-md-12">
         <h1 class="title-page" style="padding:20px;">Chemical Use</h1>
      </div>
   </div> -->
   <div class="row">
