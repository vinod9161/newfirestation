   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6 d-flex align-items-stretch" data-aos="">
            <div class="card">
               <div class="card-img">
                  <img src="{{ asset('/public/fire/gallery/dg.jpg')}}" alt="..." class="img-responsive">
               </div>
               <div class="card-body">
...
<section class="services we-offer" style="background-image: url('/public//fire/gallery/service-bg.jpg'); background-repeat: no-repeat; background-size: cover;">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
