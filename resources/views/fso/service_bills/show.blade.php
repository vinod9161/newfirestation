    ...
    <div class="card-body">
        ...
        @if($bill->payment_status=='pending')
            ...
            <div class="text-center mt-4">
                ...
                <button id="payNowBtn" class="btn btn-success mt-3">
                    Pay Online
                </button>
        ...
        @if($bill->payment_status=='paid')
            <div class="text-center mt-4">
                <a href="{{ route('service-bills.print',$bill->id) }}" class="btn btn-success" target="_blank"> <i class="fa fa-download"></i> Download Invoice </a>
            </div>
        @endif

        @php
            $backRoute = match($bill->service_type) {
                'fire_report'   => 'admin.fire_report',
                'rescue_report' => 'admin.rescue_report',
                'relief_report' => 'admin.relief_report',
                default         => 'service-bills.index',
            };
        @endphp
