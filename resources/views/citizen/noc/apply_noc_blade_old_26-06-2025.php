            ...
            <div class="tab-content">
                ...
                <div class="tab-pane text-muted" id="proprietaryTab" role="tabpanel">
                    <form id="step_two_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="single_proprietary" style="display:none;">
                            <div class="row">
                                <h3>Name Of Owner स्वामी का नाम</h3>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <h3>Contact Person Details सम्पर्क हेतु व्यक्ति का विवरण:</h3>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <h3>Architect Details आर्किटेक्ट का विवरण:</h3>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-control-label">Salutation<span class="span_required">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-danger" id="backToBasic">Back</button>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="tab-pane text-muted" id="areaTab" role="tabpanel">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="step_three_form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-danger" id="backToProprietary">Back</button>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="tab-pane text-muted" id="essentialTab" role="tabpanel">
                    <form action="" id="step_four_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-danger" id="backToArea">Back</button>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="tab-pane text-muted" id="attachmentsTab" role="tabpanel">
                    <form method="POST" enctype="multipart/form-data" id="step_five_form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-danger" id="backToEssential">Back</button>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="tab-pane text-muted" id="finalTab" role="tabpanel">
                    <form  method="POST" enctype="multipart/form-data" id="step_submit_form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-danger" id="backToAttachment">Back</button>
                            </div>
                            <div class="col-md-6">
