...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">Edit Noc</h5>
    </div>
</div>
                ...
                <div class="tab-pane text-muted show active" id="basicTab" role="tabpanel">
                    <form method="POST" id="basic_details">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="application_type" id="application_type" value="{{ $applicationDetail[0]->application_type }}">
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12" style="padding-right: 0;">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($applicationDetail[0]->building_ownership == 'owned') checked @endif type="radio" id="owned" name="building_ownership" value="owned" checked>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12" style="padding-right: 0;">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($applicationDetail[0]->gst_pan_tan == 'gst') checked @endif type="radio" id="gst" name="gst_pan_tan" value="gst" checked>
                                        <label for="gst">GST</label>
                                        <input @if($applicationDetail[0]->gst_pan_tan == 'pan') checked @endif type="radio" id="pan" name="gst_pan_tan" value="pan">
                                        <label for="pan">PAN</label>
                                        <input @if($applicationDetail[0]->gst_pan_tan == 'tan') checked @endif type="radio" id="tan" name="gst_pan_tan" value="tan">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="project_type" id="project_id" readonly>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12" style="display:none;">
                                <div class="form-group">
                                    <label class="form-label" for="input-username" style="margin-top:22px">Sub Type (Optional)</label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 occupency_div" id="occupency_div5" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="seating_capacity" name="seating_capacity" value="{{ $occupancyDetails->seating_capacity ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 occupency_div" id="occupency_div6" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_of_employee" name="no_of_employee" value="{{ $occupancyDetails->no_of_employee ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 occupency_div" id="occupency_div8" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hazardous_material" name="hazardous_material" value="{{ $occupancyDetails->hazardous_material ?? '' }}">
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-md-12 col-md-12 col-md-12 form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-primary" id="submitBasic" style="float:right;">Update & Next</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="tab-pane text-muted" id="proprietaryTab" role="tabpanel">
                    <form id="step_two_form" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6  col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <!--   <label class="form-label" >Proprietary Rights <span class="span_required">*</span></label> -->
                                    <div class="radio-toolbar">
                                        <input @if($applicationDetail[0]->proprietary_rights == 'single') checked @endif type="radio" id="single" name="proprietary_rights" value="single" checked onclick="singlePartner(this);">
                                        <label for="single">Single एकल</label>
                                        <input @if($applicationDetail[0]->proprietary_rights == 'partnership') checked @endif type="radio" id="partnership" name="proprietary_rights" value="partnership" onclick="singlePartner(this);">
                        ...
                        <div id="single_proprietary" style="display:none;">
                            @php
                                $ownerDetials = json_decode($applicationDetail[0]->owner_detail);
                                $owner_salutation = isset($ownerDetials->salutation) ? $ownerDetials->salutation : '';
                                $owner_point_of_contact = isset($ownerDetials->point_of_contact) ? $ownerDetials->point_of_contact : '';
                            @endphp
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control js-example-basic-single" name="salutation" id="salutation">
                                            ...
                                            <option @if($owner_salutation == 'Mr') selected @endif value="Mr">Mr</option>
                                            <option @if($owner_salutation == 'Ms') selected @endif value="Ms">Ms</option>
                                            <option @if($owner_salutation == 'Mrs') selected @endif value="Mrs">Mrs</option>
                                        </select>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ $ownerDetials->first_name ?? '' }}">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="middle_name" name="middle_name" placeholder="Middle Name" value="{{ $ownerDetials->middle_name ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Last Name अन्तिम नाम</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{ $ownerDetials->last_name ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Mobile No. मोबाइल नं0<span class="span_required">*</span></label>
                                        <input type="number" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No." value="{{ $ownerDetials->mobile_no ?? '' }}">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Email Address" value="{{ $ownerDetials->email ?? '' }}">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="percentage_share" name="percentage_share" placeholder="Percentage Share" value="{{ $ownerDetials->percentage_share ?? '' }}">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="radio-toolbar">
                                            <input @if($owner_point_of_contact == 'yes') checked @endif type="radio" id="owner_yes" name="point_of_contact" value="yes" onclick="contactPerson(this.value);">
                                            <label for="owner_yes">Yes</label>
                                            <input @if($owner_point_of_contact == 'no') checked @endif type="radio" id="owner_no" name="point_of_contact" value="no" checked onclick="contactPerson(this.value);">
                        ...
                        <div  id="partmership_proprietary" style="display:none;">
                            <h3>Partners Detail भागीदरों का विवरण</h3>
                            @php
                                $partnerDetails = json_decode($applicationDetail[0]->partner_detail, true) ?: [];
                            @endphp
                            @if(!empty($partnerDetails))
                                @foreach($partnerDetails as $index => $partnerDetail)
                                    @php
                                        // Extract partner details with fallback to empty strings
                                        $partner_salutation = $partnerDetail['p_salutation'] ?? '';
                                        $partner_first_name = $partnerDetail['p_first_name'] ?? '';
                                        $partner_middle_name = $partnerDetail['p_middle_name'] ?? '';
                                        $partner_last_name = $partnerDetail['p_last_name'] ?? '';
                                        $partner_mobile_no = $partnerDetail['p_mobile_no'] ?? '';
                                        $partner_percentage_share = $partnerDetail['p_percentage_share'] ?? '';
                                        $partner_point_of_contact = $partnerDetail['p_point_of_contact'] ?? '';
                                    @endphp
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control js-example-basic-single" name="p_salutation[]" id="p_salutation" required>
                                                        <option value="" disabled {{ $partner_salutation == '' ? 'selected' : '' }}>Select Salutation</option>
                                                        <option {{ $partner_salutation == 'Mr' ? 'selected' : '' }} value="Mr">Mr</option>
                                                        <option {{ $partner_salutation == 'Ms' ? 'selected' : '' }} value="Ms">Ms</option>
                                                        <option {{ $partner_salutation == 'Mrs' ? 'selected' : '' }} value="Mrs">Mrs</option>
                                                    </select>
                                                    <span class="error" id="error_27"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">First Name प्रथम नाम<span class="span_required">*</span></label>
                                                    <input type="text" class="form-control" id="p_first_name" name="p_first_name[]" placeholder="First Name" value="{{ $partner_first_name }}">
                                                    <span class="error" id="error_28"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Middle Name मध्य नाम</label>
                                                    <input type="text" class="form-control" id="p_middle_name" name="p_middle_name[]" placeholder="Middle Name" value="{{ $partner_middle_name }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Last Name अन्तिम नाम</label>
                                                    <input type="text" class="form-control" id="p_last_name" name="p_last_name[]" placeholder="Last Name" value="{{ $partner_last_name }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Mobile No. मोबाइल नं0<span class="span_required">*</span></label>
                                                    <input type="number" class="form-control" id="p_mobile_no" name="p_mobile_no[]" placeholder="Mobile No." value="{{ $partner_mobile_no }}">
                                                    <span class="error" id="error_29"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Percentage Share भागीदारी प्रतिशत<span class="span_required">*</span></label>
                                                    <input type="number" class="form-control" id="p_percentage_share" name="p_percentage_share[]" placeholder="Percentage Share" value="{{ $partner_percentage_share }}">
                                                    <span class="error" id="error_30"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="form-label">Is this person the point of contact क्या यह व्यक्ति सम्परक् किये जाने हेतु है <span class="span_required">*</span></label>
                                                    <div class="radio-toolbar">
                                                        <input type="radio" id="yes" name="p_point_of_contact[]" value="yes" {{ $partner_point_of_contact == 'yes' ? 'checked' : '' }}>
                                                        <label for="yes">Yes</label>
                                                        <input type="radio" id="no" name="p_point_of_contact[]" value="no" {{ $partner_point_of_contact == 'no' ? 'checked' : '' }}>
                                                        <label for="no">No</label>
                                                    </div>
                                                    <span class="error" id="error_31"></span>
                                                </div>
                                            </div>
                                        </div>
                                        @if ($loop->last)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="form-label">Is this person the point of contact क्या यह व्यक्ति सम्परक् किये जाने हेतु है <span class="span_required">*</span></label>
                                            <div class="radio-toolbar">
                                                <input type="radio" id="yes" name="p_point_of_contact[]" value="yes">
                                                <label for="yes">Yes</label>
                                                <input type="radio" id="no" name="p_point_of_contact[]" value="no">
                                                <label for="no">No</label>
                                            </div>
                                            <span class="error" id="error_31"></span>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            @php
                                $contactDetials = json_decode($applicationDetail[0]->contact_person);
                                $contact_person_appointed = isset($contactDetials->person_appointed) ? $contactDetials->person_appointed : '';
                                $contact_salutation = isset($contactDetials->con_salutation) ? $contactDetials->con_salutation : '';
                            @endphp
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="person_appointed" id="person_appointed" required>
                                        <option value="" disabled selected>Select</option>
                                        <option {{ $contact_person_appointed == 'Director' ? 'selected' : '' }} value="Director">Director</option>
                                        <option {{ $contact_person_appointed == 'CEO' ? 'selected' : '' }} value="CEO">CEO</option>
                                        <option {{ $contact_person_appointed == 'Proprietor' ? 'selected' : '' }} value="Proprietor">Proprietor</option>
                                        <option {{ $contact_person_appointed == 'Manager' ? 'selected' : '' }} value="Manager">Manager</option>
                                        <option {{ $contact_person_appointed == 'Other' ? 'selected' : '' }} value="Other">Other</option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="con_salutation" id="con_salutation" required>
                                        <option value="" disabled selected>Select</option>
                                        <option {{ $contact_salutation == 'Mr' ? 'selected' : '' }} value="Mr">Mr</option>
                                        <option {{ $contact_salutation == 'Ms' ? 'selected' : '' }} value="Ms">Ms</option>
                                        <option {{ $contact_salutation == 'Mrs' ? 'selected' : '' }} value="Mrs">Mrs</option>
                                    </select>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">First Name प्रथम नाम<span class="span_required">*</span></label>
                                    <input type="text" class="form-control" id="con_first_name" name="con_first_name" placeholder="First Name" value="{{ $contactDetials->con_first_name ?? '' }}">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Middle Name मध्य नाम</label>
                                    <input type="text" class="form-control" id="con_middle_name" name="con_middle_name" placeholder="Middle Name" value="{{ $contactDetials->con_middle_name ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Last Name अन्तिम नाम</label>
                                    <input type="text" class="form-control" id="con_last_name" name="con_last_name" placeholder="Last Name" value="{{ $contactDetials->con_last_name ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Mobile No. मोबाइल नं0<span class="span_required">*</span></label>
                                    <input type="number" class="form-control" id="con_mobile_no" name="con_mobile_no" placeholder="Mobile No." value="{{ $contactDetials->con_mobile_no ?? '' }}">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Email Address ई-मेल<span class="span_required">*</span></label>
                                    <input type="email" class="form-control" id="con_email" name="con_email" placeholder="Email Address" value="{{ $contactDetials->con_email ?? '' }}">
                        ...
                        <div class="row">
                            ...
                            @php
                                $architectDetials = json_decode($applicationDetail[0]->architect_detail);
                                $architect_salutation = isset($architectDetials->arc_salutation) ? $architectDetials->arc_salutation : '';
                                $firm_gst_pan_tan = isset($architectDetials->firm_gst_pan_tan) ? $architectDetials->firm_gst_pan_tan : '';
                            @endphp
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Salutation<span class="span_required">*</span></label>
                                    <select class="form-control js-example-basic-single" name="arc_salutation" id="arc_salutation" required>
                                        <option value="" disabled selected>Select</option>
                                        <option {{ $architect_salutation == 'Mr' ? 'selected' : '' }} value="Mr">Mr</option>
                                        <option {{ $architect_salutation == 'Ms' ? 'selected' : '' }} value="Ms">Ms</option>
                                        <option {{ $architect_salutation == 'Mrs' ? 'selected' : '' }} value="Mrs">Mrs</option>
                                    </select>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">First Name प्रथम नाम<span class="span_required">*</span></label>
                                    <input type="text" class="form-control" id="arc_first_name" name="arc_first_name" placeholder="First Name" value="{{ $architectDetials->arc_first_name ?? '' }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Middle Name मध्य नाम</label>
                                    <input type="text" class="form-control" id="arc_middle_name" name="arc_middle_name" placeholder="Middle Name" value="{{ $architectDetials->arc_middle_name ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Last Name अन्तिम नाम</label>
                                    <input type="text" class="form-control" id="arc_last_name" name="arc_last_name" placeholder="Last Name" value="{{ $architectDetials->arc_last_name ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Name Of Firm फर्म का नाम</label>
                                    <input type="text" class="form-control" id="name_of_firm" name="name_of_firm" placeholder="Name Of Firm" value="{{ $architectDetials->name_of_firm ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Mobile No. मोबाइल नं0<span class="span_required">*</span></label>
                                    <input type="number" class="form-control" id="arc_mobile_no" name="arc_mobile_no" placeholder="Mobile No." value="{{ $architectDetials->arc_mobile_no ?? '' }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Email ई-मेल<span class="span_required">*</span></label>
                                    <input type="text" class="form-control" id="arc_email" name="arc_email" placeholder="Email" value="{{ $architectDetials->arc_email ?? '' }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($firm_gst_pan_tan == 'gst') checked @endif type="radio" id="first_gst" name="firm_gst_pan_tan" value="gst" checked="checked">
                                        <label for="first_gst">GST</label>
                                        <input @if($firm_gst_pan_tan == 'pan') checked @endif type="radio" id="first_pan" name="firm_gst_pan_tan" value="pan">
                                        <label for="first_pan">PAN</label>
                                        <input @if($firm_gst_pan_tan == 'tan') checked @endif type="radio" id="first_tan" name="firm_gst_pan_tan" value="tan">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">GST/PAN/TAN No.जीएसटी/पैन/टैन</label>
                                    <input type="text" class="form-control" id="firm_gst_pan_tan_no" name="firm_gst_pan_tan_no" placeholder="GST/PAN/TAN No." value="{{ $architectDetials->firm_gst_pan_tan_no ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-primary" id="submitProprietary" style="float:right;">Update & Next</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="tab-pane text-muted" id="areaTab" role="tabpanel">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="step_three_form">
                        <div class="row" style="margin-top:10px;">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="total_plot_area" name="total_plot_area" placeholder="Total Area" value="{{ json_decode($applicationDetail[0]->total_plot_area)->total_plot_area ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="total_covered_area" name="total_covered_area" placeholder="Covered Area" value="{{ json_decode($applicationDetail[0]->total_covered_area)->total_covered_area ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="ground_floor_covered" name="ground_floor_covered" placeholder="Ground Floor Covered" value="{{ json_decode($applicationDetail[0]->ground_floor_covered)->ground_floor_covered ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="max_height_building" name="max_height_building" placeholder="Ground Floor Covered" value="{{ json_decode($applicationDetail[0]->max_height_building)->max_height_building ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="basement_covered_area" name="basement_covered_area" placeholder="Ground Floor Covered" value="{{ json_decode($applicationDetail[0]->basement_covered_area)->basement_covered_area ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_of_floor" name="no_of_floor" placeholder="No. of Floors" value="{{ $applicationDetail[0]->no_of_floor ?? '' }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_of_basement" name="no_of_basement" placeholder="No of Basement(s)" value="{{ $applicationDetail[0]->no_of_basement ?? '' }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_of_blocks" name="no_of_blocks" placeholder="No. of Blocks" value="{{ $applicationDetail[0]->no_of_blocks ?? '' }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="height_of_tallest_block" name="height_of_tallest_block" placeholder="Height of Tallest Block" value="{{ json_decode($applicationDetail[0]->height_of_tallest_block)->height_of_tallest_block ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="min_distance_block" name="min_distance_block" placeholder="Minimum Distance between Blocks" value="{{ json_decode($applicationDetail[0]->min_distance_block)->min_distance_block ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="approach_road_width" name="approach_road_width" placeholder="Approach Road width" value="{{ json_decode($applicationDetail[0]->approach_road_width)->approach_road_width ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="provision_no_enterance" name="provision_no_enterance" placeholder="Provision of no. of entrance" value="{{ $applicationDetail[0]->provision_no_enterance ?? '' }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="provision_no_exit" name="provision_no_exit" placeholder="Provision of no. of exit" value="{{ $applicationDetail[0]->provision_no_exit ?? '' }}">
                                    <span class="error" id="error53"></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <h3>Set Back Details सैट बैक एरिया विवरण:</h3>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Front अग्र भाग<span class="span_required">*</span></label>
                                    <input type="number" class="form-control" id="front" name="front" placeholder="Front" value="{{ json_decode($applicationDetail[0]->set_back_detail)->front ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="rear" name="rear" placeholder="Rear" value="{{ json_decode($applicationDetail[0]->set_back_detail)->rear ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="side1" name="side1" placeholder="Side-1" value="{{ json_decode($applicationDetail[0]->set_back_detail)->side1 ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="side2" name="side2" placeholder="Side-2" value="{{ json_decode($applicationDetail[0]->set_back_detail)->side2 ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-primary" id="submitArea" style="float:right;">Update & Next</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="tab-pane text-muted" id="essentialTab" role="tabpanel">
                    <form action="" id="step_four_form" method="POST" enctype="multipart/form-data">
                        ...
                        @php
                            ...
                            $compartmentation = isset($ess_provision_detail->compartmentation) ? $ess_provision_detail->compartmentation : '';
                            $emergency_exit = isset($ess_provision_detail->emergency_exit) ? $ess_provision_detail->emergency_exit : '';
                            $electric_suppy = isset($ess_provision_detail->electric_suppy) ? $ess_provision_detail->electric_suppy : '';
                            $emergency_lighting_system = isset($ess_provision_detail->emergency_lighting_system) ? $ess_provision_detail->emergency_lighting_system : '';
                            $provision_of_lift = isset($ess_provision_detail->provision_of_lift) ? $ess_provision_detail->provision_of_lift : '';
                            $provision_of_smoke = isset($ess_provision_detail->provision_of_smoke) ? $ess_provision_detail->provision_of_smoke : '';
                            $refuse_area = isset($ess_provision_detail->refuse_area) ? $ess_provision_detail->refuse_area : '';
                        @endphp
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($compartmentation == 'yes') checked @endif type="radio" id="compartmentation_yes" name="compartmentation" value="yes">
                                        <label for="compartmentation_yes">Yes हाँ</label>
                                        <input @if($compartmentation == 'no') checked @endif type="radio" id="compartmentation_no" name="compartmentation" value="no">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_of_stairs" name="no_of_stairs" placeholder="No. of Stairs" value="{{ $ess_provision_detail->no_of_stairs ?? '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="width_of_stairs" name="width_of_stairs" placeholder="Minimum Width of Stairs" value="{{ $ess_provision_detail->width_of_stairs ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($emergency_exit == 'yes') checked @endif type="radio" id="emergency_yes" name="emergency_exit" value="yes">
                                        <label for="emergency_yes">Yes हाँ</label>
                                        <input @if($emergency_exit == 'no') checked @endif type="radio" id="emergency_no" name="emergency_exit" value="no">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($provision_of_lift == 'yes') checked @endif type="radio" id="provision_yes" name="provision_of_lift" value="yes">
                                        <label for="provision_yes">Yes हाँ</label>
                                        <input @if($provision_of_lift == 'no') checked @endif type="radio" id="provision_no" name="provision_of_lift" value="no">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($electric_suppy == 'yes') checked @endif type="radio" id="electric_suppy_yes" name="electric_suppy" value="yes">
                                        <label for="electric_suppy_yes">Yes</label>
                                        <input @if($electric_suppy == 'no') checked @endif type="radio" id="electric_suppy_no" name="electric_suppy" value="no">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($emergency_lighting_system == 'yes') checked @endif type="radio" id="emergency_lighting_yes" name="emergency_lighting_system" value="yes">
                                        <label for="emergency_lighting_yes">Yes</label>
                                        <input @if($emergency_lighting_system == 'no') checked @endif type="radio" id="emergency_lighting_no" name="emergency_lighting_system" value="no">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($provision_of_smoke == 'yes') checked @endif type="radio" id="provision_of_smoke_yes" name="provision_of_smoke" value="yes">
                                        <label for="provision_of_smoke_yes">Yes हाँ</label>
                                        <input @if($provision_of_smoke == 'no') checked @endif type="radio" id="provision_of_smoke_no" name="provision_of_smoke" value="no">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input @if($refuse_area == 'yes') checked @endif type="radio" id="refuse_area_yes" name="refuse_area" value="yes">
                                        <label for="refuse_area_yes">Yes हाँ</label>
                                        <input @if($refuse_area == 'no') checked @endif type="radio" id="refuse_area_no" name="refuse_area" value="no">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="travel_distance" name="travel_distance" placeholder="Maximum Travel Distance in Building" value="{{ $ess_provision_detail->travel_distance ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="other_comment" name="other_comment" placeholder="Write something here.." style="height:70px;">{{ $ess_provision_detail->other_comment ?? '' }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-primary" id="submitEssential" style="float:right;">Update & Next</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="tab-pane text-muted" id="attachmentsTab" role="tabpanel">
                    <form method="POST" enctype="multipart/form-data" id="step_five_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="save-btn hover-btn btn btn-primary" id="submitAttachment" style="float:right;">Update & Next</button>
                            </div>
                        </div>
                    </form>
                </div>
