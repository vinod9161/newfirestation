                ...
                <div class="tab-pane text-muted show active" id="basicTab" role="tabpanel">
                    <form method="POST" id="basic_details">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label" for="input-username">Building Name {{ $application_type ?? 'pre establishment noc'}}<span class="span_required">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input type="radio" id="owned" name="building_ownership" value="owned"
                                            {{ (isset($applicationDetail[0]) && $applicationDetail[0]->building_ownership == 'owned') ? 'checked' : '' }}>
                                        <label for="owned">Owned स्वयं की</label>

                                        <input type="radio" id="occupied" name="building_ownership" value="occupied"
                                            {{ (isset($applicationDetail[0]) && $applicationDetail[0]->building_ownership == 'occupied') ? 'checked' : '' }}>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12" style="padding-right: 0;">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input type="radio" id="gst" name="gst_pan_tan" value="gst"
                                            {{ (isset($applicationDetail[0]) && $applicationDetail[0]->gst_pan_tan == 'gst') ? 'checked' : '' }}>
                                        <label for="gst">GST</label>

                                        <input type="radio" id="pan" name="gst_pan_tan" value="pan"
                                            {{ (isset($applicationDetail[0]) && $applicationDetail[0]->gst_pan_tan == 'pan') ? 'checked' : '' }}>
                                        <label for="pan">PAN</label>

                                        <input type="radio" id="tan" name="gst_pan_tan" value="tan"
                                            {{ (isset($applicationDetail[0]) && $applicationDetail[0]->gst_pan_tan == 'tan') ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">District जनपद<span class="span_required">*</span></label>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#district_id', function () {
            ...
            // Urban: Tehsil
            $.post("getTehsilByDistrict", { district_id }, function (response) {
                $('#tehsil_id').html(response);
            });

            // Rural: Blocks
            $.post("getBlockByDistrict", { district_id }, function (response) {
                $('#block_id').html(response);
            });
            $.post("getUrbanBodyByTehsil", { district_id }, function (response) {
                $('#urban_body_id').html(response);
            });
        });

        // Tehsil → Urban Body (City)
        // $(document).on('change', '#tehsil_id', function () {
        //     let tehsil_id = $(this).val();

        //     $.post("getUrbanBodyByTehsil", { tehsil_id }, function (response) {
        //         $('#urban_body_id').html(response);
        //     });
        // });
        ...
        $(document).on('change', '#urban_body_id', function () {
            ...
            $.post("getWardByUrbanBody", { urban_body_id }, function (response) {
        ...
        $(document).on('change', '#block_id', function () {
            ...
            $.post("getPanchayatByBlock", { block_id }, function (response) {
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", "#submitBasic", function (e) {
            ...
            if (formData.rural_urban === "rural") {
                ...
                if (!formData.urban_body_id) errors.push({ id: "error13", msg: "City / Urban Body is required" });
                if (!formData.ward_id) errors.push({ id: "error13", msg: "Ward is required" });
