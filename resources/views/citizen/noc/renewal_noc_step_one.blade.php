...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">Apply Renewal Noc</h5>
    </div>
</div>
                ...
                <div class="tab-pane text-muted show active" id="basicTab" role="tabpanel">
                    <form method="POST" id="basic_details">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="application_type" id="application_type" value="renewal noc">
                            <input type="hidden" name="noc_type" id="noc_type" value="{{ $noc_type ?? ''}}">
                            <input type="hidden" name="pre_perational" id="pre_perational" value="{{$pre_operational}}">
