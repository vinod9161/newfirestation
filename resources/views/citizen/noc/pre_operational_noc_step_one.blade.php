...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">Apply Pre Operational Noc</h5>
    </div>
</div>

@if($applicationDetail[0]->status == 'pending' || $applicationDetail[0]->status == 'processed')
...
@elseif($applicationDetail[0]->status == 'reverted')
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane text-muted show active" id="basicTab" role="tabpanel">
                    <form method="POST" id="basic_details">
                        @csrf
                        <div class="row">
                            <input type="hidden" id="old_application_no" name="old_application_no" value="{{ $application_no ?? '' }}">
                            <input type="hidden" name="application_type" id="application_type" value="pre operational noc">
                            <input type="hidden" name="noc_type" id="noc_type" value="">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="building_name" name="building_name" placeholder="Building Name" value="{{ ucfirst(Auth::user()->building_name) ?? ''}}">
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12" style="padding-right: 0;">
                                <div class="form-group">
                                    ...
                                    <div class="radio-toolbar">
                                        <input type="radio" id="owned" name="building_ownership" value="owned">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="project_type" id="project_id" disabled>
                                        @foreach ($projects as $prd)
                                            <option value="{{ $prd->id }}">{{ ucfirst($prd->name) }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row" id="urban_div" style="display:none;">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="street" name="street" placeholder="Street" value="{{ $application->street ?? ''}}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city" placeholder="City" value="{{ $application->city ?? ''}}">
                        ...
                        <div class="row" id="rular_div" style="display:none;">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="village" name="village" placeholder="Village" value="{{ $application->village ?? ''}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="plot_khasra_khatauni_no" name="plot_khasra_khatauni_no" placeholder="Plot/Khasra/Khatoni No." value="{{ $application->plot_khasra_khatauni_no ?? ''}}">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="pincode" name="pincode" placeholder="Pincode" value="{{ $application->pincode ?? ''}}" maxlength="6" minlength="6">
                ...
                <div class="tab-pane text-muted" id="proprietaryTab" role="tabpanel">
                    <form id="step_two_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <h5>Fire Vendor Details फायर वेंडर विवरण:</h5>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="form-label">Salutation<span class="span_required">*</span></label>
            ...
            $.ajax({
                ...
                success: function(response) 
                {
                   // console.log(response);
                    ...
                    {
                        let subCategoryValue = '<option vlaue="">---- Select Sub Category ----</option>';
                        $.each(objSubCategory.data, function(key, value) {
                            subCategoryValue += '<option value="'+value.id+'">'+value.name+'</option>';
                        });
                        $('#subcategory_id').html(subCategoryValue);
                    }
                    else{
                        let subCategoryValue = '<option vlaue="">---- Select Sub Category ----</option>';
                        subCategoryValue += '<option value="">'+objSubCategory.message+'</option>';
                        $('#subcategory_id').html(subCategoryValue);
                    }
                }
            });
        ...
        if(subCategoryId != '' && _token != '')
        {
            $.ajax({
                ...
                success: function(response) 
                {
                    ...
                    {
                        let categoryValue = '<option vlaue="">---- Select Category ----</option>';
                        $.each(objCategory.data, function(key, value) {
                            categoryValue += '<option value="'+value.id+'" selected>'+value.name+'</option>';
                        });
                        $('#category_id').html(categoryValue);
                    }
                    else{
                        let categoryValue = '<option vlaue="">---- Select Category ----</option>';
                        categoryValue += '<option value="">'+objCategory.message+'</option>';
                        $('#category_id').html(categoryValue);
                    }
                }
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", "#submitBasic", function (e) {
            ...
            const formData = {
                ...
                old_application_no : $('input[name="old_application_no"]').val()?.trim() || ''
            };
            $("[id^=error]").html("");
            $("#errorBlock").hide();
            let errors = [];
