...
<div class="card custom-card" id="hori">
    <div class="card-body">
        <div class="text-wrap">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('noc.step.first.post')}}">
                @csrf
                    ...
                    <fieldset>
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Building Name भवन का नाम <span class="span_required">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="gst_pan_tan_no" name="gst_pan_tan_no" placeholder="GST/PAN/TAN No." value="{{ $application->gst_pan_tan_no ?? ''}}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-10 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  js-example-basic-single" name="project_type" id="project_id" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-10 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-username">Sub Type</label>
                            ...
                            <div class="row" id="occupency_row">
                                ...
                                <div class="col-md-6 col-sm-10 col-xs-12 occupency_div" id="occupency_div4" style="display:none;">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control  js-example-basic-single" name="district_id" id="district_id" required>
                                            <option value="" selected>Select District जनपद</option>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="radio-toolbar">
                                            ...
                                            <label for="rular">Rular ग्रामीण</label>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control  js-example-basic-single" name="tehsil_id" id="tehsil_id" required>
                                                <option value="" selected>Select Tehsil तहसील चुनें</option>
                                            </select>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control  js-example-basic-single" name="block_id" id="block_id" required>
                                                <option value="" disabled selected>Select Block विकासखण्ड चुनें</option>
