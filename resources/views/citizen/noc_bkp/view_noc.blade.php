		...
		<div class="text-wrap">
			...
			<div class="example">
				<nav class="nav nav-style-1 nav-pills mb-3" role="tablist">
					...
					@if(Auth::user()->type== 4 && $applicationDetail[0]->status=='approved' && $applicationDetail[0]->application_type == 'pre establishment noc' && !$applicationDetail[0]->operational_applications)
				...
				<div class="tab-content">
					...
					<div class="tab-pane text-muted" id="nav-offers" role="tabpanel">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<span><b>Area : </b>{{json_decode($applicationDetail[0]->total_plot_area)->total_plot_area ?? ''." Sqmt"}}
								</span>
							</div>
							<div class="col-md-4">
					...
					@if(isset($applicationDetail[0]->operational_applications))
					<div class="tab-pane text-muted" id="nav-Fire" role="tabpanel">
						<h5>Vendor detail</h5>
						<hr>
						<div class="row">
							<div class="col-md-4">
								<label class="form-label">Name of Fire Vendor :</label><br><span>{{json_decode($applicationDetail[0]->operational_applications->vendor)->vendor_name ?? ''}} </span>
							</div>
							<div class="col-md-4">
								<label class="form-label">Name Of Firm : </label><br>
								<span>{{json_decode($applicationDetail[0]->operational_applications->vendor)->vendor_firm_name ?? ''}}</span>
							</div>
							<div class="col-md-4">
								<label class="form-label">Mobile No. : </label><br>
								<span>{{json_decode($applicationDetail[0]->operational_applications->vendor)->vendor_number ?? ''}} </span>
							</div>
							<div class="col-md-4">
								<label class="form-label">GST/PAN/TAN</label><br>
								<span>{{ucfirst(json_decode($applicationDetail[0]->operational_applications->vendor)->vendor_gst_pan_tan ?? '')}} </span>
							</div>
							<div class="col-md-4">
								<label class="form-label">GST/PAN/TAN No. : </label><br>
								<span>{{json_decode($applicationDetail[0]->operational_applications->vendor)->vendor_gst_pan_tan_no ?? ''}} </span>
							</div>
							<div class="col-md-4">
								<label class="form-label">Email : </label><br>
								<span>{{json_decode($applicationDetail[0]->operational_applications->vendor)->vendor_email ?? ''}}</span>
							</div>
						</div>
					</div>
					@endif
