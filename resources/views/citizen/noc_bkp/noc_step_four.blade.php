...
<div class="card custom-card" id="hori">
    <div class="card-body">
        <div class="text-wrap">
            ...
            <form action="{{route('noc.step.forth.post')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="body-box-admin">
                    <fieldset>
                        <legend>Essential Provision आवश्यक प्राविधान:</legend>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_of_stairs" name="no_of_stairs" placeholder="No. of Stairs" value="{{json_decode($application->ess_provision_detail)->no_of_stairs ?? old('no_of_stairs') ?? '' }}" required>
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="width_of_stairs" name="width_of_stairs" placeholder="Minimum Width of Stairs" value="{{json_decode($application->ess_provision_detail)->width_of_stairs ?? old('width_of_stairs') ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="travel_distance" name="travel_distance" placeholder="Maximum Travel Distance in Building" value="{{ json_decode($application->ess_provision_detail)->travel_distance ?? old('travel_distance') ?? '' }}" step="any" pattern="^\d*(\.\d{0,2})?$">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="other_comment" name="other_comment" placeholder="Write something here.." style="height:70px;">{{ json_decode($application->ess_provision_detail)->other_comment ?? old('travel_distance') ?? '' }}</textarea>
                    ...
                    <div class="col-lg-12 text-right mt-3">
                        <a href="" class="btn btn-sm btn-neutral">Cancel</a>
