...
@section('title')
<title>Stand By | Citizen Dashboard</title>
@endsection
@section('style')
...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
   ...
   <div class="d-flex app-header-btn">
      ...
      <div>
         <a href="<?php echo route('citizen.addStandby'); ?>" class="btn ripple btn-wave  btn-success mb-0">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                           <a href="{{route('citizen.viewStandby', $row->id)}}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> &nbsp;</a>
                        </td>
                     </tr>
                     @endforeach
                  </tbody>
