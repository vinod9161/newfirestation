        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="table-responsive---">
                    ...
                    @endif
                    <div class="col-md-12">
                        <form action="{{ route('citizen.saveIncident') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" value="{{ Auth::user()->building_name }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="district_id" id="district_id" class="form-control js-example-basic-single">
                                            ...
                                            <option value="{{ $dist->id }}" @if($dist->id == Auth::user()->district_id) selected @endif>{{ $dist->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile_no" id="mobile_no" class="form-control" value="{{ Auth::user()->number }}">
