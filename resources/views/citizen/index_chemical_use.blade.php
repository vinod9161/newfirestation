    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <img src="{{ asset('/public/citizen/health_image.png') }}" style="width:100%;height:350px;object-fit: contain;">
                    </div>
                    <div class="col-md-6">
                        <img src="{{ asset('/public/citizen/flammability.png') }}" style="width:100%;height:350px;object-fit: contain;">
                    </div>
                    <div class="col-md-6">
                        <img src="{{ asset('/public/citizen/reactivity.png') }}" style="width:100%;height:350px;object-fit: contain;">
                    </div>
                    <div class="col-md-6">
                        <img src="{{ asset('/public/citizen/special.png') }}" style="width:100%;height:350px;object-fit: contain;">
                    </div>
                    <div class="col-md-6">
                        <img src="{{ asset('/public/citizen/5.png') }}" style="width:100%;height:350px;object-fit: contain;">
                    </div>
                </div>
            </div>
        </div>
