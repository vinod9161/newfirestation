...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">NOC For Temporary Permission of Transportation of Harmful and Hazardous Materials</h5>
    </div>
</div>
<!-- End Row -->
<div class="row">
                            ...
                            <div class="tab-pane text-muted" id="tab7" role="tabpanel">
                                <form method="POST" id="project">
                                     <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Mode of Transport<span class="span_required">*</span></label>
                                                <select class="form-control"  name="mode_of_transport" id="mode_of_transport" required>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Means of Transport (Vehicle)- Type and Details<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="means_of_transport" name="means_of_transport" placeholder="Means of Transport (Vehicle)- Type and Details" value="" required>
                                                <span class="error" id="error56"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Number of Transport Vehicle for Hazardous Material <span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="no_of_transport" name="no_of_transport" placeholder="Number of Transport Vehicle for Hazardous Material" value="" required>
                                                <span class="error" id="error57"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Name of Hazardous Material<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="name_of_hazardous_material" name="name_of_hazardous_material" placeholder="Name of Hazardous Material" value="" required>
                                                <span class="error" id="error58"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Category/Class of Hazardous Material <span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="category_of_hazardous_material" name="category_of_hazardous_material" placeholder="Category/Class of Hazardous Material" value="" required>
                                                <span class="error" id="error59"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Capacity of Transported Hazardous Material <span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="capacity_of_hazardous_material" name="capacity_of_hazardous_material" placeholder="Capacity of Transported Hazardous Material" value="" required>
                                                <span class="error" id="error60"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Number of Person including in Transportation<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="no_of_person" name="no_of_person" placeholder="Number of Person including in Transportation" value="" required>
                                                <span class="error" id="error61"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Expected Date of Transportation<span class="span_required">*</span></label>
                                                <input type="date" class="form-control" id="expected_date" name="expected_date" placeholder="TExpected Date of Transportation" value="" required>
                                                <span class="error" id="error62"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Expected Time of Transportation<span class="span_required">*</span></label>
                                                <input type="time" class="form-control" id="expected_time" name="expected_time" placeholder="TExpected Time of Transportation" value="" required>
                                                <span class="error" id="error63"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Route of Transportation example: A to D via B,C,etc
                                                <span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="route_transportation" name="route_transportation" placeholder="Route of Transportation example: A to D via B,C,etc" value="" required>
                            ...
                            <div class="tab-pane text-muted" id="tab8" role="tabpanel">
                                <form method="POST" id="attachments">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">SOP for handling Hazardous materials<span class="span_required">*</span></label>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Attached the plan of Root Chart<span class="span_required">*</span></label>
                                        ...
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                            <button class="save-btn hover-btn btn btn-primary mb-3" type="button" onclick="formAttachmentDetails()">Save</button>
                                        </div>
                                    </div>    
                                </form>
                            </div>
...
<script>
    ...
    function formBasicDetails()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: "{{route('noc.transportation.basic.post')}}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function formApplicantDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.transportation.applicant.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizingDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.transportation.organizing.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizerDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.transportation.organizer.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formErectorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.transportation.erector.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formCoordinatorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.transportation.coordinator.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formProjectDetails()
    {
        ...
        const mode_of_transport = $('#mode_of_transport').val();
        const means_of_transport = $('input[name="means_of_transport"]').val();
        const no_of_transport = $('input[name="no_of_transport"]').val();
        const name_of_hazardous_material = $('input[name="name_of_hazardous_material"]').val();
        const category_of_hazardous_material = $('input[name="category_of_hazardous_material"]').val();
        const end_date = $('input[name="capacity_of_hazardous_material"]').val();
        const no_of_person = $('input[name="no_of_person"]').val();
        const expected_date = $('input[name="expected_date"]').val();
        const expected_time = $('input[name="expected_time"]').val();
        const route_transportation = $('input[name="route_transportation"]').val();
        function validateField(field, errorId)
        {
            if (!field) {
                $('#' + errorId).html("This field is.");
        ...
        const fieldsToValidate = [
            ...
            { field: mode_of_transport, errorId: 'error55' },
            { field: means_of_transport, errorId: 'error56' },
            { field: no_of_transport, errorId: 'error57' },
            { field: name_of_hazardous_material, errorId: 'error58' },
            { field: category_of_hazardous_material, errorId: 'error59' },
            { field: capacity_of_hazardous_material, errorId: 'error60' },
            { field: no_of_person, errorId: 'error61' },
            { field: expected_date, errorId: 'error62' },
            { field: expected_time, errorId: 'error63' },
            { field: route_transportation, errorId: 'error64' }
        ];
        ...
        formData.append('mode_of_transport', mode_of_transport);
        formData.append('means_of_transport', means_of_transport);
        formData.append('no_of_transport', no_of_transport);
        formData.append('name_of_hazardous_material', name_of_hazardous_material);
        formData.append('category_of_hazardous_material', category_of_hazardous_material);
        formData.append('capacity_of_hazardous_material', capacity_of_hazardous_material);
        formData.append('no_of_person', no_of_person);
        formData.append('expected_date', expected_date);
        formData.append('expected_time', expected_time);
        formData.append('route_transportation', route_transportation);
        $.ajax({
            url: "{{route('noc.transportation.project.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formAttachmentDetails()
    {
        ...
        const fieldsToValidate = [
            { field: reference_letter, errorId: 'error65' },
            { field: fire_plan, errorId: 'error66' },
            { field: route_plan, errorId: 'error67' },
        ];
        fieldsToValidate.forEach(({ errorId }) => $('#' + errorId).html(""));
        const isValid = fieldsToValidate.every(({ field, errorId }) => validateField(field, errorId));
        if (!isValid)
        ...
        $.ajax({
            url: "{{route('noc.transportation.attachments.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
