...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">NOC For Temporary Permission of Flim Shooting</h5>
    </div>
</div>
<!-- End Row -->
<div class="row">
...
<script>
    ...
    function formBasicDetails()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: "{{route('noc.film.shooting.basic.post')}}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function formApplicantDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.film.shooting.applicant.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizingDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.film.shooting.organizing.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizerDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.film.shooting.organizer.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formErectorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.film.shooting.erector.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formCoordinatorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.film.shooting.coordinator.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formProjectDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.film.shooting.project.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formAttachmentDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.film.shooting.attachments.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
