...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">NOC For Temporary Permission of Entertainment Activity</h5>
    </div>
</div>
<!-- End Row -->
<div class="row">
...
<script>
    ...
    function formBasicDetails()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: "{{route('noc.entertainment.basic.post')}}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function formApplicantDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.entertainment.applicant.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizingDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.entertainment.organizing.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizerDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.entertainment.organizer.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formErectorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.entertainment.erector.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formCoordinatorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.entertainment.coordinator.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formProjectDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.entertainment.project.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formAttachmentDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.entertainment.attachments.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
