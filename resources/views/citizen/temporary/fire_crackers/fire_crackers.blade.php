...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">NOC For Temporary Permission of Fire Crackers</h5>
    </div>
</div>
<!-- End Row -->
<div class="row">
                            ...
                            <div class="tab-pane text-muted" id="tab7" role="tabpanel">
                                <form method="POST" id="project">
                                     <div class="row">
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Duration From<span class="span_required">*</span></label>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Duration To<span class="span_required">*</span></label>
                                                <input type="date" class="form-control" id="to_date" name="to_date" placeholder="Covered Area" value="">
                                                <span class="error" id="error55"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Capacity<span class="span_required">*</span></label>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Distance From nearest petrol pump<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="distance_from_nearest_petrol_pump" name="distance_from_nearest_petrol_pump" placeholder="Distance of from nearest Petrol Pump/Gas Agency" value="">
                                                <span class="error" id="error57"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Whether Shop/Building<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="shop_building" name="shop_building" placeholder="Whether Shop/Building" value="">
                                                <span class="error" id="error58"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Name of Item <span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="name_of_item" name="name_of_item" placeholder="Name of Item" value="">
                                                <span class="error" id="error59"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Other Detail<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="other_detail" name="other_detail" placeholder="Other Detail" value="">
                            ...
                            <div class="tab-pane text-muted" id="tab8" role="tabpanel">
                                <form method="POST" id="attachments">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                            <button class="save-btn hover-btn btn btn-primary mb-3" type="button" onclick="formAttachmentDetails()">Save Changes</button>
                                        </div>
                                    </div>    
                                </form>
                            </div>
...
<script>
    ...
    function formBasicDetails()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: "{{route('noc.fire.crackers.basic.post')}}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function formApplicantDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.fire.crackers.applicant.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizingDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.fire.crackers.organizing.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizerDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.fire.crackers.organizer.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formErectorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.fire.crackers.erector.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formCoordinatorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.fire.crackers.coordinator.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formProjectDetails()
    {
        ...
        const distance_from_nearest_petrol_pump = $('input[name="distance_from_nearest_petrol_pump"]').val();
        const shop_building = $('input[name="shop_building"]').val();
        const name_of_item = $('input[name="name_of_item"]').val();
        const other_detail = $('input[name="other_detail"]').val();
        function validateField(field, errorId)
        {
            if (!field) {
                $('#' + errorId).html("This field is required.");
        ...
        const fieldsToValidate = [
            { field: from_date, errorId: 'error54' },
            { field: to_date, errorId: 'error55' },
            { field: capacity, errorId: 'error56' },
            { field: distance_from_nearest_petrol_pump, errorId: 'error57' },
            { field: shop_building, errorId: 'error58' },
            { field: name_of_item, errorId: 'error59' },
            { field: other_detail, errorId: 'error60' }
        ];
        ...
        formData.append('distance_from_nearest_petrol_pump', distance_from_nearest_petrol_pump);
        formData.append('shop_building', shop_building);
        formData.append('name_of_item', name_of_item);
        formData.append('other_detail', other_detail);
        $.ajax({
            url: "{{route('noc.fire.crackers.project.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formAttachmentDetails()
    {
        ...
        const fieldsToValidate = [
            { field: reference_letter, errorId: 'error61' }
        ];
        fieldsToValidate.forEach(({ errorId }) => $('#' + errorId).html(""));
        const isValid = fieldsToValidate.every(({ field, errorId }) => validateField(field, errorId));
        if (!isValid)
        ...
        $.ajax({
            url: "{{route('noc.fire.crackers.attachments.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
