...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">NOC For Temporary Permission of Games/Sports</h5>
    </div>
</div>
<!-- End Row -->
<div class="row">
                            ...
                            <div class="tab-pane text-muted" id="tab7" role="tabpanel">
                                <form method="POST" id="project">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Type of Sport<span class="span_required">*</span></label>
                                                <select class="form-control" name="sport_type" id="sport_type" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <span class="error" id="error82"></span>
...
<script>
    ...
    function formBasicDetails()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: "{{route('noc.games.basic.post')}}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function formApplicantDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.games.applicant.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizingDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.games.organizing.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizerDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.games.organizer.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formErectorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.games.erector.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formCoordinatorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.games.coordinator.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formProjectDetails()
    {
        ...
        const sport_type = $('#sport_type').val();
        ...
        const fieldsToValidate = [
            ...
            { field: sport_type, errorId: 'error68' },
            { field: seating_capacity, errorId: 'error69' },
            { field: security_person, errorId: 'error70' },
            { field: road_width, errorId: 'error71' },
            { field: parking, errorId: 'error72' },
            { field: no_entrance, errorId: 'error73' },
            { field: entrance_height, errorId: 'error74' },
            { field: entrance_width, errorId: 'error75' },
            { field: no_exit, errorId: 'error76' },
            { field: exit_height, errorId: 'error77' },
            { field: exit_width, errorId: 'error78' },
        ];
        ...
        $.ajax({
            url: "{{route('noc.games.project.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formAttachmentDetails()
    {
        ...
        const fieldsToValidate = [
            { field: reference_letter, errorId: 'error80' },
            { field: fire_plan, errorId: 'error82' }
        ];
        fieldsToValidate.forEach(({ errorId }) => $('#' + errorId).html(""));
        const isValid = fieldsToValidate.every(({ field, errorId }) => validateField(field, errorId));
        if (!isValid)
        ...
        $.ajax({
            url: "{{route('noc.games.attachments.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
