...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">NOC For Temporary Permission of Structure/Pandal/Mela</h5>
    </div>
</div>
<!-- End Row -->
<div class="row">
                            ...
                            <div class="tab-pane text-muted" id="tab2" role="tabpanel">
                                <form method="POST" id="applicant_details">
                                    <div class="row" style="margin-top: 0px;">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label>Urban / Rural <span class="span_required">*</span></label>
                                                <div class="radio-toolbar">
                                        ...
                                        <div class="row" id="urban_div" style="display:none">
                                            ...
                                            <!-- Tehsil -->
                                            <div class="col-md-3">
                                                <label>Tehsil <span class="span_required">*</span></label>
                                            ...
                                            <!-- Urban Body (City) -->
                                            <div class="col-md-3">
                                                <label>City / Urban Body <span class="span_required">*</span></label>
                                                <select class="form-control" name="urban_body_id" id="urban_body_id">
                                            ...
                                            <!-- Ward -->
                                            <div class="col-md-3">
                                                <label>Ward <span class="span_required">*</span></label>
                                            ...
                                            <!-- Street -->
                                            <div class="col-md-3">
                                                <label>Street <span class="span_required">*</span></label>
                                                <input type="text" class="form-control" name="street" id="street">
                                            </div>

                                        </div>

                                        <div class="row" id="rural_div" style="display:none">

                                            <div class="col-md-3">
                                                <label>Block <span class="span_required">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <label>Panchayat <span class="span_required">*</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <label>Village <span class="span_required">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label>Landmark <span class="span_required">*</span></label>
                                                <input type="text" class="form-control" name="landmark">
                                            </div>

                                            <div class="col-md-6 mt-3">
                                                <label>Plot / Khasra / Khatoni <span class="span_required">*</span></label>
                                                <div class="radio-toolbar">
                                                    <input type="radio" name="plot_khasra_khatauni" value="plot"> Plot
                                                    <input type="radio" name="plot_khasra_khatauni" value="khasra"> Khasra
                                                    <input type="radio" name="plot_khasra_khatauni" value="khatoni"> Khatoni
                                                </div>
                                            </div>

                                            <div class="col-md-3">
                                                <label>Number <span class="span_required">*</span></label>
                                                <input type="text" class="form-control" name="plot_khasra_khatauni_no">
                                            </div>

                                            <div class="col-md-3">
                                                <label>Pincode <span class="span_required">*</span></label>
                                ...
                                <form method="POST" id="organizing">
                                    <div class="row" style="margin-top:0px">
                                        ...
                                        <div class="col-md-6">
                                            <label>Urban / Rural <span class="span_required">*</span></label>
                                            <div class="radio-toolbar">
                                                <input type="radio" id="org_urban" name="org_rural_urban" value="urban">
                                                <label for="org_urban">Urban</label>

                                                <input type="radio" id="org_rural" name="org_rural_urban" value="rural">
                                                <label for="org_rural">Rural</label>
                                            </div>
                                        </div>

                                    </div>
                                    <div class="row" id="org_urban_div" style="display:none">
                                        ...
                                        <div class="col-md-3">
                                            <label>City / Urban Body <span class="span_required">*</span></label>
                                            <select class="form-control" name="org_urban_body_id" id="org_urban_body_id">
                                                <option value="">Select City / Urban Body</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <label>Ward <span class="span_required">*</span></label>
                                            <select class="form-control" name="org_ward_id" id="org_ward_id">
                                                <option value="">Select Ward</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row" id="org_rural_div" style="display:none">
                                        ...
                                        <div class="col-md-3">
                                            <label>Village <span class="span_required">*</span></label>
                                            <input type="text" class="form-control" name="org_village">
                                        </div>
                            ...
                            <div class="tab-pane text-muted" id="tab7" role="tabpanel">
                                <form method="POST" id="project">
                                     <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Total Plot Area<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="total_plot_area" name="total_plot_area" placeholder="Total Area" value="">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Unit<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" name="plot_area_unit" id="plot_area_unit"  value="Sqmt" readonly>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Unit<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" name="covered_area_unit" id="covered_area_unit" value="Sqmt" readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Type of Activity<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="function_type" name="function_type" placeholder="Type of Entertainment/Function Activity" value="">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Number of Camps<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="no_camps" name="no_camps" placeholder="Number of Camps" value="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Number of Stalls<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="no_stalls" name="no_stalls" placeholder="Number of Stalls" value="">
                                                <span class="error" id="error62"></span>
                                            </div>
                                        </div>
                                        <!-- Provision of Kitchen/Food Stall -->
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Provision of Kitchen/Food Stall<span class="span_required">*</span></label>
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="pro_kitchen_yes" name="pro_kitchen" value="yes">
                                                    <label for="pro_kitchen_yes">Yes</label>
                                                    <input type="radio" id="pro_kitchen_no" name="pro_kitchen" value="no">
                                                    <label for="pro_kitchen_no">No</label>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Boundary<span class="span_required">*</span></label>
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="temporary" name="boundary" value="temporary">
                                                    <label for="temporary">Temporary</label>
                                                    <input type="radio" id="permanent" name="boundary" value="permanent">
                                                    <label for="permanent">Permanent</label>
                                                    <span class="error" id="error64"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Use of Inflammable Item -->
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Use of Inflammable Item<span class="span_required">*</span></label>
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="inflammable_yes" name="inflammable" value="yes">
                                                    <label for="inflammable_yes">Yes</label>
                                                    <input type="radio" id="inflammable_no" name="inflammable" value="no">
                                                    <label for="inflammable_no">No</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Type of Inflammable Item<span class="span_required">*</span></label>
                                                <input type="text" class="form-control" id="inflamable_type" name="inflamable_type" placeholder="Type of Inflammable" value="">
                                                <span class="error" id="error66"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Whether the Activity is Open or Indoor<span class="span_required">*</span></label>
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="open" name="open_indoor" value="open" style="height: auto">
                                                    <label for="open">Open</label>
                                                    <input type="radio" id="indoor" name="open_indoor" value="indoor" style="height: auto">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Seating Capacity of Stage<span class="span_required">*</span></label>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Number of Fire/Security Personnel<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="security_person" name="security_person" placeholder="Fire/Security Person" value="">
                                                <span class="error" id="error69"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Width of Approach Road (in Meters)<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="road_width" name="road_width" placeholder="Approach Road" value="">
                                                <span class="error" id="error70"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-username">Separate Parking Area<span class="span_required">*</span></label>
                                                <div class="radio-toolbar">
                                                    <input type="radio" id="parking_yes" name="parking" value="yes" style="height: auto">
                                                    <label for="parking_yes">Yes</label>
                                                    <input type="radio" id="parking_no" name="parking" value="no" style="height: auto">
                                                    <label for="parking_no">No</label>
                                                    <span class="error" id="error71"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Number of Entrances<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="no_entrance" name="no_entrance" placeholder="No. of Entrance" value="">
                                                <span class="error" id="error72"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Height of Entrance (in Meters)<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="entrance_height" name="entrance_height" placeholder="Entrance Height" value="">
                                                <span class="error" id="error73"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Width of Entrance (in Meters)<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="entrance_width" name="entrance_width" placeholder="Entrance Width" value="">
                                                <span class="error" id="error74"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Number of Exits<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="no_exit" name="no_exit" placeholder="No. of Exit" value="">
                                                <span class="error" id="error75"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Height of Exit (in Meters)<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="exit_height" name="exit_height" placeholder="Exit Height" value="">
                                                <span class="error" id="error76"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">Width of Exit (in Meters)<span class="span_required">*</span></label>
                                                <input type="number" class="form-control" id="exit_width" name="exit_width" placeholder="Exit Width" value="">
                                                <span class="error" id="error77"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <span class="error" id="error78"></span>
                                              
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">If Yatra is organizing attached the route plan and No. of Person Participate in Yatra<span class="span_required">*</span></label>
                                                <input type="file" class="form-control" id="route_plan" name="route_plan" style="height: 36px;">
                                                <span class="error" id="error79"></span>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <span class="error" id="error80"></span>
...
<script>
    $(document).ready(function() {
        ...
        $('input[name="org_rural_urban"]').on('change', function () {
            if ($(this).val() === 'urban') {
                $('#org_urban_div').show();
                $('#org_rural_div').hide();

                $('#org_urban_div *').prop('disabled', false);
                $('#org_rural_div *').prop('disabled', true);
            } else {
                $('#org_urban_div').hide();
                $('#org_rural_div').show();

                $('#org_rural_div *').prop('disabled', false);
        ...
        $(document).on('change', '#org_district_id', function () {
            ...
            // Urban – Tehsil
            $.post("{{ route('getTehsilByDistrict') }}", {
                district_id,
                _token: "{{ csrf_token() }}"
            }, function (res) {
                $('#org_tehsil_id').html(res);
                $('#org_urban_body_id').html('<option value="">Select City / Urban Body</option>');
                $('#org_ward_id').html('<option value="">Select Ward</option>');
            });

            // Rural – Block
            $.post("{{ route('getBlockByDistrict') }}", {
                district_id,
                _token: "{{ csrf_token() }}"
            }, function (res) {
                $('#org_block_id').html(res);
                $('#org_panchayat_id').html('<option value="">Select Panchayat</option>');
            });
        });
        $(document).on('change', '#org_urban_body_id', function () {
            let urban_body_id = $(this).val();

            $.post("{{ route('getWardByUrbanBody') }}", {
                urban_body_id,
                _token: "{{ csrf_token() }}"
            }, function (res) {
                $('#org_ward_id').html(res);
            });
        });
        $(document).on('change', '#org_block_id', function () {
            let block_id = $(this).val();

            $.post("{{ route('getPanchayatByBlock') }}", {
                block_id,
                _token: "{{ csrf_token() }}"
            }, function (res) {
                $('#org_panchayat_id').html(res);
            });
        });
    ...
    // District → Tehsil (Urban) + Block (Rural)
    $(document).on('change', '#district_id', function () {
        ...
        $.post("{{ route('getTehsilByDistrict') }}", {
            ...
            $('#urban_body_id').html('<option value="">Select City / Urban Body</option>');
            $('#ward_id').html('<option value="">Select Ward</option>');
        });

        $.post("{{ route('getUrbanBodyByTehsil') }}", {
            district_id: district_id,
            _token: "{{ csrf_token() }}"
        }, function (res) {
            $('#urban_body_id').html(res);
            $('#ward_id').html('<option value="">Select Ward</option>');
        });
    ...
    function formBasicDetails()
    {
        ...
        const noc_type = "{{ $noc_type }}";
        console.log(noc_type);
        if (!applicant_type)
        {
        ...
        else
        {
            ...
            $.ajax({
                url: "{{route('noc.pandal.basic.post')}}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function formApplicantDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.pandal.applicant.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizingDetails()
    {
        ...
        const org_rplot_khasra_khatauni = document.querySelector('input[name="org_plotkhasrakhatauni"]:checked');
        ...
        $.ajax({
            url: "{{route('noc.pandal.organizing.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizerDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.pandal.organizer.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formErectorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.pandal.erector.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formCoordinatorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.pandal.coordinator.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formProjectDetails()
    {
        const _token = $('input[name="_token"]').val();
        const application_no = $('#application_no').val();
        const total_plot_area = $('input[name="total_plot_area"]').val();
        const plot_area_unit = $('input[name="plot_area_unit"]').val();
        const total_covered_area = $('input[name="total_covered_area"]').val();
        const covered_area_unit = $('input[name="covered_area_unit"]').val();
        const function_type = $('input[name="function_type"]').val();
        const start_date = $('input[name="start_date"]').val();
        const end_date = $('input[name="end_date"]').val();
        const no_camps = $('input[name="no_camps"]').val();
        const no_stalls = $('input[name="no_stalls"]').val();
        const pro_kitchen = $('input[name="pro_kitchen"]').val();
        const boundary = document.querySelector('input[name="boundary"]:checked');
        const inflammable = $('input[name="inflammable"]').val();
        const inflamable_type = $('input[name="inflamable_type"]').val();
        const open_indoor = $('input[name="open_indoor"]').val();
        const seating_capacity = $('input[name="seating_capacity"]').val();
        const security_person = $('input[name="security_person"]').val();
        const road_width = $('input[name="road_width"]').val();
        const parking = $('input[name="parking"]').val();
        const no_entrance = $('input[name="no_entrance"]').val();
        const entrance_height = $('input[name="entrance_height"]').val();
        const entrance_width = $('input[name="entrance_width"]').val();
        const no_exit = $('input[name="no_exit"]').val();
        const exit_height = $('input[name="exit_height"]').val();
        const exit_width = $('input[name="exit_width"]').val();
        function validateField(field, errorId)
        {
            if (!field) {
                $('#' + errorId).html("This field is.");
        ...
        const fieldsToValidate = [
            { field: total_plot_area, errorId: 'error54' },
            { field: plot_area_unit, errorId: 'error55' },
            { field: total_covered_area, errorId: 'error56' },
            { field: covered_area_unit, errorId: 'error57' },
            { field: function_type, errorId: 'error58' },
            { field: start_date, errorId: 'error59' },
            { field: end_date, errorId: 'error60' },
            { field: no_camps, errorId: 'error61' },
            { field: no_stalls, errorId: 'error62' },
            { field: pro_kitchen, errorId: 'error63' },
            { field: boundary, errorId: 'error64' },
            { field: inflammable, errorId: 'error65' },
            { field: inflamable_type, errorId: 'error66' },
            { field: open_indoor, errorId: 'error67' },
            { field: seating_capacity, errorId: 'error68' },
            { field: security_person, errorId: 'error69' },
            { field: road_width, errorId: 'error70' },
            { field: parking, errorId: 'error71' },
            { field: no_entrance, errorId: 'error72' },
            { field: entrance_height, errorId: 'error73' },
            { field: entrance_width, errorId: 'error74' },
            { field: no_exit, errorId: 'error75' },
            { field: exit_height, errorId: 'error76' },
            { field: exit_width, errorId: 'error77' },
        ];
        ...
        formData.append('_token', _token);
        formData.append('application_no', application_no);
        formData.append('total_plot_area', total_plot_area);
        formData.append('plot_area_unit', plot_area_unit);
        formData.append('total_covered_area', total_covered_area);
        formData.append('covered_area_unit', covered_area_unit);
        formData.append('function_type', function_type);
        formData.append('start_date', start_date);
        formData.append('end_date', end_date);
        formData.append('no_camps', no_camps);
        formData.append('no_stalls', no_stalls);
        formData.append('pro_kitchen', pro_kitchen);
        formData.append('boundary', boundary.value);
        formData.append('inflammable', inflammable);
        formData.append('inflamable_type', inflamable_type);
        formData.append('open_indoor', open_indoor);
        formData.append('seating_capacity', seating_capacity);
        formData.append('security_person', security_person);
        formData.append('road_width', road_width);
        formData.append('parking', parking);
        formData.append('no_entrance', no_entrance);
        formData.append('entrance_height', entrance_height);
        formData.append('entrance_width', entrance_width);
        formData.append('no_exit', no_exit);
        formData.append('exit_height', exit_height);
        formData.append('exit_width', exit_width);
        $.ajax({
            url: "{{route('noc.pandal.project.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formAttachmentDetails()
    {
        ...
        const route_plan = $('input[name="route_plan"]')[0].files[0];
        ...
        const fieldsToValidate = [
            { field: reference_letter, errorId: 'error78' },
            { field: route_plan, errorId: 'error79' },
            { field: fire_plan, errorId: 'error80' }
        ];
        fieldsToValidate.forEach(({ errorId }) => $('#' + errorId).html(""));
        const isValid = fieldsToValidate.every(({ field, errorId }) => validateField(field, errorId));
        if (!isValid)
        ...
        formData.append('route_plan', route_plan);
        formData.append('fire_plan', fire_plan);
        $.ajax({
            url: "{{route('noc.pandal.attachments.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
