...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0 mt-10">NOC For Temporary Permission of Other Services</h5>
    </div>
</div>
<!-- End Row -->
<div class="row">
                            ...
                            <div class="tab-pane text-muted" id="tab8" role="tabpanel">
                                <form method="POST" id="attachments" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="form-label">If Any Other Attachment<span class="span_required">*</span></label>
                                                <input type="file" class="form-control" id="other_doc" name="other_doc" style="height: 36px;">
                                                <span class="error" id="error80"></span>
...
<script>
    ...
    function formBasicDetails()
    {
        ...
        else
        {
            ...
            $.ajax({
                url: "{{route('noc.other.services.basic.post')}}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
    ...
    function formApplicantDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.other.services.applicant.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizingDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.other.services.organizing.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formOrganizerDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.other.services.organizer.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formErectorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.other.services.erector.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formCoordinatorDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.other.services.coordinator.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    function formProjectDetails()
    {
        ...
        $.ajax({
            url: "{{route('noc.other.services.project.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    {
        alert($('input[name="reference_letter"]')[0].files[0]);
        const _token = $('input[name="_token"]').val();
        const application_no = $('#application_no').val();
        ...
        const other_doc = $('input[name="other_doc"]')[0].files[0];
        function validateField(field, errorId)
        {
            if (!field) {
                $('#' + errorId).html("This field is required.");
        ...
        const fieldsToValidate = [
            ...
            { field: other_doc, errorId: 'error81' }
        ];
        fieldsToValidate.forEach(({ errorId }) => $('#' + errorId).html(""));
        const isValid = fieldsToValidate.every(({ field, errorId }) => validateField(field, errorId));
        if (!isValid)
        ...
        $.ajax({
            url: "{{route('noc.other.services.attachments.post')}}",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
