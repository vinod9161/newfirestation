...
<div class="row">
    ...
    <div class="col-sm-6 col-md-6 col-xl-3"> 
        <div class="card custom-card"> 
            <a href="{{route('citizen.activity.home')}}">
                <div class="card-body d-flex align-items-center">
                    <div class="service-image" style="width:60px; height:60px;"> 
                        <img src="{{ asset('/public/citizen/activity.png') }}" alt="" style="width:60px; height:60px; object-fit:contain">
                    </div>  
                    <div class="service-info"> 
                        <h6 class="dash-12 mb-2" style="padding-left:10px;">Activities</h6> 
                    </div> 
                </div>
            </a>
        </div>
