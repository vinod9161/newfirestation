...
<div class="d-md-flex d-block align-items-center  justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Upload SOP</h5>
    </div>
</div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 me2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Chemical Name" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 me2">
                                <div class="form-group">
                                    <label class="form-label"> Upload SOP <span class="text-danger">*</span></label>
