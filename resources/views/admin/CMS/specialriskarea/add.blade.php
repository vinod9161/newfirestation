        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="table-responsive---">
                    ...
                    <form action="{{ route('admin.saveSpecialRiskArea') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="vulnerable_areas" id="vulnerable_areas" rows="10"></textarea>
