...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default fs-24 mg-b-4 mb-0">Add Medal Winners
        </h5>
    </div>
                ...
                <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.achivements.medal_winners.save') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="fire_station" id="fire_station" class="form-control js-example-basic-single">
                                                        ...
                                                        @foreach ($fire_stations as $category)
                                                        <option value="{{ $category->id }}">
                                                            {{ $category->name }}
                                                        </option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Districts<sup class="text-danger">*</sup></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="year" id="year" placeholder="YYYY" class="form-control">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="occassion" id="occassion" placeholder="Occassion" class="form-control">
