...
@section('title')
<title>Add Welfare and Amenity Fund</title>
@endsection
@section('style')
                    ...
                    <div class="col-md-12" style="margin:0 auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.welfareamenity.save') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Order Number<sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control" name="number" id="number" placeholder="Order Number" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control js-example-basic-single" name="type" id="type" required>
                                                    ...
                                                    <option value="Housing and Accommodation">Housing and Accommodation</option>
                                                    <option value="Retirement and Pension Schemes">Retirement and Pension Schemes</option>
                                                    ...
                                                    <option value="Education and Scholarships">Education and Scholarships</option>
                                                    <option value="Recognition and Awards">Recognition and Awards</option>
                                                    <option value="Support for Martyrs' Families">Support for Martyrs' Families</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="file" id="file" placeholder="Select File For Walfare and Amenity File" required>
                                        ...
                                        <div class="col-md-4" style="margin:0 auto; margin-top:30px">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-sm w-100" id="addgo">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    $(document).ready(function(){
        $('#addgo').on('click', function(){
            ...
            else if(file === '')
            {
                ...
                $('#fileErr').html('Only PDF files are allowed').fadeIn().delay(3000).fadeOut();
                return false;
            }
            else if(id == '')
            {
