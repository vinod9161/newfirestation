        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="table-responsive---">
                    ...
                    <form action="{{ route('admin.updateRecentUpdates') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="{{ $recentupdates[0]->title }}">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="status" data-trigger>
                                        ...
                                        <option {{ $recentupdates[0]->status == 0 ? 'selected' : '' }} value="0">Inactive </option>
                                        <option {{ $recentupdates[0]->status == 1 ? 'selected' : '' }} value="1">Active </option>
                                    </select>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="10">{{ $recentupdates[0]->description }}</textarea>
                                    <span class="text-danger" id="error_4"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <input type="hidden" id="id" name="id" value="{{ $recentupdates[0]->id }}">
