...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
   ...
   <div class="d-flex app-header-btn">
      ...
      <div>
         <a href="<?php echo route('admin.addRecentUpdatesForm'); ?>" class="btn ripple btn-wave  btn-success mb-0">
            <i class="fe fe-plus me-1"></i> Add Recent Updates
         </a>
      </div>
   </div>
</div>
         ...
         <div class="card-body">
            <div class="table-responsive">
               ...
               <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                  ...
                  <tbody>
                     @foreach ($recentupdates as $index => $row)
                     <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $row->title }}</td>
                        <td>{{ $row->document }}</td>
