                ...
                <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.serviceorder.save') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#addcard').on('click', function (e) {
            ...
            if (!cardImage) {
                $('#card_imageError').html('Service Order File is required').show().delay(3000).fadeOut();
                e.preventDefault();
            }
