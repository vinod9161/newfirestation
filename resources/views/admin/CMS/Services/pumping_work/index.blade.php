...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Pumping Work
</h5>
    </div>
    <div class="d-flex app-header-btn">

        <div>
            <a href="<?php echo route('admin.services.pumping_work.add'); ?>" class="btn ripple btn-wave  btn-success mb-0">
                    ...
                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                        ...
                        @foreach($history as $key => $value)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>{{ $value->hadding }}</td>
                                <td><img src="{{ asset('public/admin/services/pumping_work/'. $value->image) }}" alt="Image" width="100"></td>
                                <td>{{ $value->content }}</td>
                                <td>{{ $value->status }}</td>
                                <td>
