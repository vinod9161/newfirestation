...
@section('title')
<title>Update Pumping Work | Admin Dashboard</title>
@endsection
...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default fs-24 mg-b-4 mb-0">Update Pumping Work</h5>
    </div>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-header">
                <div class="card-title">Update Pumping Work</div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.services.pumping_work.update', $pumpingWork->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Heading <sup class="text-danger">*</sup></label>
                                                    <input type="text" name="hadding" id="hadding" class="form-control" value="{{ old('hadding', $pumpingWork->hadding) }}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="imageposition" id="imageposition" class="form-control">
                                                        ...
                                                        <option value="right" {{ old('imageposition', $pumpingWork->image_position) == 'right' ? 'selected' : '' }}>Right</option>
                                                        <option value="left" {{ old('imageposition', $pumpingWork->image_position) == 'left' ? 'selected' : '' }}>Left</option>
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    @if ($pumpingWork->image)
                                                        <div class="mt-3">
                                                            <label>Current Image:</label>
                                                            <img src="{{ asset('public/admin/services/pumping_work/'. $pumpingWork->image) }}" alt="Current Image" class="img-fluid" style="max-height: 100px;">
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="description" id="card_content" value="{{ old('description', $pumpingWork->content) }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Set the existing content into the editor
        var cardContentField = document.getElementById('card_content');
        quill.root.innerHTML = cardContentField.value;
        ...
        $('#addcard').on('click', function (e) {
            ...
            if (!hadding) {
                $('#card_heddingError').html('Heading is required').show().delay(3000).fadeOut();
                e.preventDefault();
            }
            ...
            if (!cardImage && !@json($pumpingWork->image)) {
