                    ...
                    <div class="col-md-12" style="margin:0 auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.savestaffstrength') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="cfo_accepted" id="cfo_accepted" class="form-control" placeholder="Enter CFO Accepted Value">
                                        </div>

                                        <div class="col-md-4 form-group">
                                            <label>CFO Available मुख्य अग्निशमन अधिकारी उपलब्ध<sup class="text-danger">*</sup></label>
                                            <input type="text" name="cfo_available" id="cfo_available" class="form-control" placeholder="Enter CFO Available Value">
                                        </div>


                                        <div class="col-md-4 form-group">
                                            <label>FSO Accepted अग्निशमन अधिकारी स्वीकृत<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fso_accepted" id="fso_accepted" class="form-control" placeholder="Enter FSO Accepted Value">
                                        </div>

                                        <div class="col-md-4 form-group">
                                            <label>FSO Available अग्निशमन अधिकारी उपलब्ध<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fso_available" id="fso_available" class="form-control" placeholder="Enter FSO Available Value">
                                        </div>


                                        <div class="col-md-4 form-group">
                                            <label>FSSO Accepted अग्निशमन द्वितीय अधिकारी स्वीकृत<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fsso_accepted" id="fsso_accepted" class="form-control" placeholder="Enter FSSO Accepted Value">
                                        </div>

                                        <div class="col-md-4 form-group">
                                            <label>FSSO Available अग्निशमन द्वितीय अधिकारी उपलब्ध<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fsso_available" id="fsso_available" class="form-control" placeholder="Enter FSSO Available Value">
                                        </div>


                                        <div class="col-md-4 form-group">
                                            <label>Leading Fireman Accepted लीडिंग फायरमैन स्वीकृत<sup class="text-danger">*</sup></label>
                                            <input type="text" name="lf_accepted" id="lf_accepted" class="form-control" placeholder="Enter Leading Fireman Accepted Value">
                                        </div>

                                        <div class="col-md-4 form-group">
                                            <label>Leading Fireman Available लीडिंग फायरमैन उपलब्ध<sup class="text-danger">*</sup></label>
                                            <input type="text" name="lf_available" id="lf_available" class="form-control" placeholder="Enter Leading Fireman Available Value">
                                        </div>


                                        <div class="col-md-4 form-group">
                                            <label>Fireman Accepted फायरमैन स्वीकृत<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fm_accepted" id="fm_accepted" class="form-control" placeholder="Enter Fireman Accepted Value">
                                        </div>

                                        <div class="col-md-4 form-group">
                                            <label>Fireman Available फायरमैन उपलब्ध<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fm_available" id="fm_available" class="form-control" placeholder="Enter Fireman Available Value">
                                        </div>


                                        <div class="col-md-4 form-group">
                                            <label>Fire Service Driver Accepted फायर सर्विस चालक स्वीकृत<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fsd_accepted" id="fsd_accepted" class="form-control" placeholder="Enter Fire Service Driver Accepted Value">
                                        </div>

                                        <div class="col-md-4 form-group">
                                            <label>Fire Service Driver Available फायर सर्विस चालक उपलब्ध<sup class="text-danger">*</sup></label>
                                            <input type="text" name="fsd_available" id="fsd_available" class="form-control" placeholder="Enter Fire Service Driver Available Value">
                                        </div>

                                        <div class="col-md-4 form-group" style="margin-top:30px">
                                            <button type="submit" name="staff" id="staff" class="btn btn-primary btn-sm w-100">Submit</button>
                                        </div>

                                        <div class="col-md-4 form-group" style="margin-top:30px">
                                            <button type="reset" name="reset" id="reset" class="btn btn-danger btn-sm w-100">Reset Form</button>
                                        </div>
