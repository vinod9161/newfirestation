...
@section('title')
<title>Tutorial | Admin Dashboard</title>
@endsection
...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    <div class="d-flex app-header-btn">
        ...
        <div>
            ...
            <a
                href="{{ route('admin.about.tutorial.add') }}"
                            ...
                            @if(!empty($tutorials))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a
                                            href="{{ route('admin.about.tutorial.edit', $tutorial->id) }}"
                                        ...
                                        <a
                                            href="{{ route('admin.about.tutorial.delete', $tutorial->id) }}"
