                ...
                <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.bannerslider.save') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Banner Text <sup class="text-danger">*</sup></label>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#addcard').on('click', function (e) {
            ...
            if (!cardImage) {
                $('#card_imageError').html('Banner Image is required').show().delay(3000).fadeOut();
                e.preventDefault();
            }
