...
@section('title')
<title>Academy Course | Admin Dashboard</title>
@endsection
@section('style')
...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Academy Course</h5>
    </div>
    <div class="d-flex app-header-btn">
 
        <div>
            <a href="<?php echo route('admin.getcourse'); ?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-eye me-1"></i> View Course
            </a>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#addcard').on('click', function (e) {
            ...
            if (!service_name) {
                $('#serviceNameErrorr').html('Course Name is required').show().delay(3000).fadeOut();
                e.preventDefault();
            }
        });
    });
