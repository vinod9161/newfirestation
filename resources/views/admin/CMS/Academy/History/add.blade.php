...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    <div class="d-flex app-header-btn">
        ...
        <div>
            <a href="<?php echo route('admin.gethistory'); ?>" class="btn ripple btn-wave  btn-success mb-0">
                ...
                <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.history.save') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#addcard').on('click', function (e) {
            ...
            if (!cardImage) {
                $('#card_imageError').html('History File is required').show().delay(3000).fadeOut();
                e.preventDefault();
            }
