...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    <div class="d-flex app-header-btn">
        ...
        <div>
            <a href="<?php echo route('admin.getistitutionalstructure'); ?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-eye me-1"></i> View Institutional Structure
            </a>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.istitutionalstructure.update') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Institutional Structure Name <sup class="text-danger">*</sup></label>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#addcard').on('click', function (e) {
            ...
            if (!service_name) {
                $('#serviceNameErrorr').html('Institutional Structure Name is required').show().delay(3000).fadeOut();
                e.preventDefault();
            }
        });
    });
