        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="table-responsive---">
                    ...
                    <form action="{{ route('admin.saveOrganisational') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name Of Officer">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="firestation" name="firestation" placeholder="Fire Station">
