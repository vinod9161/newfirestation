                    ...
                    <div class="col-md-12" style="margin:0 auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.go.circular.post') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Act/Rule/Order Number<sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control" name="number" id="number" placeholder="Act/Rule/Order Number" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control js-example-basic-single" name="type" id="type" required>
                                                    ...
                                                    <option value="Code/Norms">Code/Norms</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Go Circular<sup class="text-danger">*</sup></label>
                                                <input type="file" class="form-control" name="file" id="file" placeholder="Select File For Go Circular" required>
...
<script>
    $(document).ready(function(){
        $('#addgo').on('click', function(){
            ...
            {
                $('#fileErr').html('Required Go Circular File For Upload').delay(3000).fadeOut().css('display','block');
                return false;  
            }
