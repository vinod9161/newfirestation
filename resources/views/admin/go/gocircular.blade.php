...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    @if(Auth::user()->type == 0)
        <div>
            <a href="<?php echo route('admin.add-go-circular');?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-plus me-1"></i> Add GO Circular
            </a>
        </div>
    @endif    
                ...
                <div class="table-responsive">
                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                        <thead>
                            ...
                            <?php $sn=1; if(!empty($getGo)):?>
                            <?php foreach($getGo as $key => $val):?>
                                <tr>
                                    <td>{{ $sn; }}</td>
                                    ...
                                    @if (Auth::user()->type == '0' || Auth::user()->type == '1' || Auth::user()->type == '4')
                                        <td> 
                                            <a href="{{ route('admin.edit-go-circular', $val->id) }}" class="btn btn-sm btn-dark"><i class="fa fa-edit"></i></a>
                                            <a  onclick="return confirm('Are you sure you want to delete this?')" 
                                                    href="{{ route('admin.go.circular.delete', $val->id) }}" 
