...
<form action="{{ route('admin.storedistrict') }}" method="POST">
    ...
    <h2 class="text-center" style="background-color:#42425d;color:#ffffff">Add District Details</h2>
       ...
       <div class="row mt-3" style="padding: 0 30px 25px;">
            <div class="col-md-4 col-sm-6 col-xs-12">
                ...
                <input type="text" class="form-control" id="name" name="name" placeholder="District Name" value="" required="">
                </div>
            </div>
