    ...
    <div class="col-xl-12">
        <div class="card custom-card">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1"
                                    ...
                                    style="width: 134px;">District Details<div style="height: 25px;"></div>
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1"
            ...
            <tr>
                ...
                <td class="text-right">
                    <a href="{{ route('admin.editdistrict', $district->id) }}" class="btn btn-primary btn-sm">Edit</a>
                    <form action="{{ route('admin.deletedistrict', $district->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
