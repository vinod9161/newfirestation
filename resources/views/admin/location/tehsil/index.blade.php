...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Manage Location / Tehsil</h5>
    </div>
    <div class="d-flex app-header-btn">
        ...
        <div>
            <a href="<?php echo route('admin.addtehsil');?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-plus me-1"></i> Add New Tehsil
            </a>
        </div>
    </div>
</div>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form action="{{ route('admin.Tehsilfilter') }}" method="GET" class="advanced-search br-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1"
                                    ...
                                    style="width: 134px;">Tehsil Details<div style="height: 25px;"></div>
                                </th>
                        ...
                        @foreach ($tehsils as $index => $district)
                            <tr>
                                <td>{{ $index + 1 }}</td> 
                                <td>{{ $district->name }}</td>
                                ...
                                <td class="text-right">
                                    <a href="{{ route('admin.edittehsil', $district->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                    <form action="{{ route('admin.deletetehsil', $district->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
