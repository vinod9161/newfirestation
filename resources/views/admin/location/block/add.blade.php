...
@endif
<form action="{{ route('admin.storeblock') }}" method="POST">
    @csrf
    <div class="body-box-admin tab-content card" style="padding:0px">
        <h2 class="text-center" style="background-color:#42425d;color:#ffffff">Add Block Details</h2>
        ...
        <div class="row mt-3" style="padding: 0 30px 25px;">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label class="form-label">Block Name <span class="required" style="color:red">*</span></label>
            ...
            <div class="col-md-4 col-sm-10 col-xs-12">
                <div class="form-group">
                    ...
                    <input class="form-control" name="description" id="description" placeholder="Description" value="{{ old('description') }}">
                </div>
            </div>
        </div>
