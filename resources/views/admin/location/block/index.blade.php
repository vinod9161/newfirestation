...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Manage Location / Block</h5>
    </div>
    <div class="d-flex app-header-btn">
        ...
        <div>
            <a href="<?php echo route('admin.addblock');?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-plus me-1"></i> Add New Block
            </a>
        </div>
    </div>
</div>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form action="{{ route('admin.blockfilter') }}" method="GET" class="advanced-search br-3">
                        ...
                        @foreach ($tehsils as $index => $district)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <form action="{{ route('admin.deleteblock', $district->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
