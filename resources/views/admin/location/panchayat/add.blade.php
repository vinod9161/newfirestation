...
@endif
<form action="{{ route('admin.storetehsil') }}" method="POST">
    @csrf
    <div class="body-box-admin tab-content card" style="padding:0px">
        <h2 class="text-center" style="background-color:#42425d;color:#ffffff">Add Panchayat Details</h2>
        ...
        <div class="row mt-3" style="padding: 0 30px 25px;">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Tehsil Name" value="{{ old('name') }}" required>
                    @error('name')
            ...
            <div class="col-md-3 col-sm-10 col-xs-12">
                <div class="form-group">
                    ...
                    <select class="form-control" name="district_name" id="district_name" data-trigger required>
            ...
            <div class="col-md-3 col-sm-10 col-xs-12">
                <div class="form-group">
                    <label class="form-control-label">Select Tahsil <span class="required" style="color:red">*</span></label>
                    <select class="form-control" name="district_name" id="district_name" data-trigger required>
            ...
            <div class="col-md-3 col-sm-10 col-xs-12">
                <div class="form-group">
                    <label class="form-control-label">Select Block <span class="required" style="color:red">*</span></label>
                    <select class="form-control" name="district_name" id="district_name" data-trigger required>
