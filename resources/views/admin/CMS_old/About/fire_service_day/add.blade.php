...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    <div class="d-flex app-header-btn">
        <div>
            <a href="{{ route('admin.about.Fire_Service_Day') }}" class="btn ripple btn-wave btn-success mb-0">
                ...
                <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.about.Fire_Service_Day.save') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
