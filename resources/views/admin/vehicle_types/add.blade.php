                ...
                <div class="table-responsive---">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12" style="margin:0 auto;">
                            <form action="{{ route('admin.saveVehicleTypes') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Vehicle Type<sup class="text-danger">*</sup></label>      
                                            <input class="form-control"  name="vehicle_type" id="vehicle_type" type="text" placeholder="Vehicle Type" required />               
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
