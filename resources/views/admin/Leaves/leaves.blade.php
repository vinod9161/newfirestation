...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Manage Leaves</h5>
    </div>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
                                    ...
                                    Sender Name<div style="height: 25px;"></div>
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
                                    aria-label="Name: activate to sort column ascending" style="width: 153px;">Receiver Name<div
                                        style="height: 25px;"></div>
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
                                    aria-label="Gender: activate to sort column ascending" style="width: 67px;">Frome Date
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
               ...
               $i = 1;
               @endphp 
               @foreach($manage_work as $data)
               @php
                $sender = DB::table('users')->where('id', $data->user_id)->first();
                $receiver = DB::table('users')->where('id', $data->assign_to)->first();
               @endphp
