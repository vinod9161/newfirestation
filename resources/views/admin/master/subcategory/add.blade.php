...
<form action="{{route('admin.saveSubCategory')}}" method="POST" enctype="multipart/form-data">
   @csrf
   <div class="body-box-admin">
      <div class="body-box-admin tab-content card" style="padding:0px">
         <h2 class="text-center heading_info">Add Sub Category</h2>
         ...
         <div class="pl-lg-4 text-right mb-3">
            <a href="{{route('admin.subcategory')}}" class="btn btn-sm btn-secondary">Back</a>
