...
<div class="header-page">
   <div class="row">
      <div class="col-md-8">
         <h1 class="title-page">Manage Project</h1>
      </div>
      <div class="col-md-4 text-right">
         <div class="search-form" style="padding-right: 0px">
            <a href="{{route('admin.addProjectForm')}}" class="btn btn-light-green">Add New Project</a>
         </div>
      </div>
   </div>
</div>
   ...
   <div class="body-box-admin p-0">
    @if(session()->has('message'))
      ...
      <div class="table-responsive">
         <table class="table ucp-table table-hover table-bordered display" cellpadding="0" cellspacing="0" width="100%" id="project-table">
            <thead>
               <tr>
            ...
            <tr class="my-job-item">
               ...
               <td class="d-none d-md-table-cell text-right">
                  <a href="{{route('admin.editProjectForm', $cat->id)}}" class="btn btn-light btn-edit" title="Edit"><i class="fas fa-pencil-alt"></i> &nbsp;</a>
                  <a onclick="return confirm('Are you sure you Want to Delete ?')" href="{{route('admin.deleteProject', $cat->id)}}" class="btn btn-light btn-delete" title="Delete"><i class="far fa-trash-alt"></i> </a>
               </td>
            </tr>
            @php
            $i++;
