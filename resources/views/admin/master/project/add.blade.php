...
<form action="{{route('admin.saveProject')}}" method="POST" enctype="multipart/form-data">
   @csrf
<div class="body-box-admin">
<div class="body-box-admin tab-content card" style="padding:0px">
   <h2 class="text-center heading_info">Add Project</h2>
   ...
   <div class="row mt-3" style="padding: 0 30px 25px;">
         <div class="col-md-4 col-sm-6 col-xs-12">
               ...
               <a href="{{route('admin.project')}}" class="btn btn-sm btn-secondary">Back</a>
