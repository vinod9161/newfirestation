...
<div class="row">
<div class="col-md-3">
<h1 class="title-page">Edit Project</h1>
</div>
...
<section class="box-admin edit-profile">
         ...
         <form action="{{route('admin.updateProject')}}" method="POST" enctype="multipart/form-data">
          @csrf
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
               <div class="form-group">
                  ...
                  <select class="form-control" name="status" id="status">
                    ...
                    <option value="0" <?php if($project->status ==0) { echo "selected"; } ?>>In-Active</option>
                  </select>
               </div>
              </div>
               ...
               <a href="{{route('admin.project')}}" class="btn btn-sm btn-neutral">Back</a>
