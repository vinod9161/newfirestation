    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="post" enctype="multipart/form-data" action="{{route('admin.updateRescueReport')}}">
                    @csrf
                    <div class="divborder">
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="rescue_report_no" id="rescue_report_no" type="number" value="{{ $rescueReport[0]->rescue_report_no }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="monthly_no" id="monthly_no" type="number" value="{{ $rescueReport[0]->monthly_no }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="datetime-local" id="rescue_incident_datetime" name="rescue_incident_datetime" max=""  value="{{ $rescueReport[0]->rescue_incident_datetime }}">
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="225" name="informer_name" id="informer_name" type="text"  value="{{ $rescueReport[0]->informer_name }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="informer_contact_no" id="informer_contact_no" type="number" value="{{ $rescueReport[0]->informer_contact_no }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="info_medium" id="info_medium" type="text" value="{{ $rescueReport[0]->info_medium }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" maxlength="512" name="incident_address" id="incident_address" value="{{ $rescueReport[0]->incident_address }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="datetime-local" id="info_datetime" name="info_datetime" max="" value="{{ $rescueReport[0]->info_datetime }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="incident_longitude" id="incident_longitude" value="{{ $rescueReport[0]->longitude }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="incident_latitude" id="incident_latitude" value="{{ $rescueReport[0]->latitude }}">
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="datetime-local" id="station_depart_datetime" name="station_depart_datetime" max="" value="{{ $rescueReport[0]->station_depart_datetime }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="datetime-local" id="rescue_site_arrive_datetime" name="rescue_site_arrive_datetime" value="{{ $rescueReport[0]->rescue_site_arrive_datetime }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="datetime-local" id="station_return_datetime" name="station_return_datetime" value="{{ $rescueReport[0]->station_return_datetime }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="distance" id="distance" type="number" step="any" pattern="^\d*(\.\d{0,3})?$" value="{{ $rescueReport[0]->distance }}">
                    ...
                    <div class="divborder">
                        ...
                        @php 
                            $vehicle = json_decode($rescueReport[0]->vehicle_id); 
                            $pumping = json_decode($rescueReport[0]->pumping_km);
                        @endphp
                    ...
                    <div class="divborder">
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            ...
                            @php 
                                $cfoArray = explode(',',$rescueReport[0]->cfo); 
                                $fsoArray = explode(',',$rescueReport[0]->fso);
                                $fssoArray = explode(',',$rescueReport[0]->fsso);
                                $lfmArray = explode(',',$rescueReport[0]->lfm);
                                $dvrArray = explode(',',$rescueReport[0]->dvr);
                                $fmArray = explode(',',$rescueReport[0]->fm);
                            @endphp
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>CFO</label>
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="rescue_area" id="rescue_area">
                                        <option {{ $rescueReport[0]->rescue_area == 1 ? 'selected' : '' }} value="1">Rural ग्रामीण</option>
                                        <option {{ $rescueReport[0]->rescue_area == 2 ? 'selected' : '' }} value="2">City शहरी</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="rescue_area_type" id="rescue_area_type">
                                        <option {{ $rescueReport[0]->rescue_area_type == 1 ? 'selected' : '' }} value="1">Disaster आपदा</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 2 ? 'selected' : '' }} value="2">Earth Quick भूकम्प</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 3 ? 'selected' : '' }} value="3">Land Slide भूस्खलन</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 4 ? 'selected' : '' }} value="4">Flood बाढ़</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 5 ? 'selected' : '' }} value="5">Road Accident सड़क दुर्घटना</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 6 ? 'selected' : '' }} value="6">Building Colipase भवन धंसना</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 7 ? 'selected' : '' }} value="7">Gas Leak गैस लीकेज</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 8 ? 'selected' : '' }} value="8">Patient मरीज</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 9 ? 'selected' : '' }} value="9">Rescue of Animal/Bird पशु पक्षियों का रेस्क्यू</option>
                                        <option {{ $rescueReport[0]->rescue_area_type == 10 ? 'selected' : '' }} value="10">Other अन्य</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="insured" id="insured">
                                        <option {{ $rescueReport[0]->insured == 0 ? 'selected' : '' }} value="0">Not known</option>
                                        <option {{ $rescueReport[0]->insured == 1 ? 'selected' : '' }} value="1">No</option>
                                        <option {{ $rescueReport[0]->insured == 2 ? 'selected' : '' }} value="2">Yes</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" maxlength="1000" name="rescue_reason" id="rescue_reason" value="{{ $rescueReport[0]->rescue_reason }}">
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="life_lost_human" id="life_lost_human" type="number" value="{{ $rescueReport[0]->life_lost_human }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="life_saved_human" id="life_saved_human" type="number" value="{{ $rescueReport[0]->life_saved_human }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="life_lost_animal" id="life_lost_animal" type="number" value="{{ $rescueReport[0]->life_lost_animal }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="life_saved_animal" id="life_saved_animal" type="number" value="{{ $rescueReport[0]->life_saved_animal }}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" maxlength="1000" name="description" id="description" style="height:50px;">{{ $rescueReport[0]->short_description }}</textarea>
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="ytupload" type="hidden" value="" name="upload" value="{{ $rescueReport[0]->upload }}" />
                    ...
                    <div class="row">
                        <div class="col-md-12" align="center">
                           <input type="hidden" name="id" id="id" value="{{ $rescueReport[0]->id }}">
                            <button type="submit" id="submitButton" class="btn btn-primary w-30" style="width:30%">Update Report</button>
                        </div>
                    </div>
