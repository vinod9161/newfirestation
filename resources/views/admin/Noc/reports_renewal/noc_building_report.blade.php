   ...
   <body>
      ...
      <div class="container">
            ...
            <div style="width:100%;margin-top:30px;">
               <h2 style="text-align:center;">Annual Clearance NOC वार्षिक परिचालन अग्निसुरक्षा प्रमाण पत्र </h2>
            </div>
                  ...
                  <table class="table" id="house-table" border="1" style="width:100%;border:1px solid black;border-collapse: collapse;">
                     <tbody>
                        ...
                        <tr style="line-height: 20px;">
                           ...
                           @else
                           <td style="text-align: center;
                              font-size: 14px;" colspan="6">{{ucfirst($applicationDetail->plot_khasra_khatauni).' : '.$applicationDetail->plot_khasra_khatauni_no .', '.ucfirst($applicationDetail->street).', '.ucfirst($applicationDetail->village).', '.ucfirst($applicationDetail->landmark).', '.ucfirst($applicationDetail->district->name).', '.ucfirst($applicationDetail->pincode)}}</td>
                           @endif
                        </tr>
                        <tr>
                           <td style="padding-left:10px;
               ...
               @if($applicationDetail->status=='approved')
               <table class="table" id="hou-table" border="1" style="width: 100%; border: 1px solid black;
                  ...
                  <tbody>
                     ...
                     <tr style="line-height:40px">
                        <td style="text-align:center;font-size:14px;width:30%;">
                           Pre Approver/पूर्व अनुमोदन<br>
                           <img src="{{ asset($dd->signature) }}" alt="client" width="70" height="70" class="shadow-sm mr-3"/>
                           <br>
                           {{$dd->name}}
                           <br>
                           Approved Date / स्वीकृति दिनांक <br> {{$applicationDetail->updated_at }}
                        </td>
                        <td style="text-align:center;font-size:14px;width:30%;">Verifier/सत्यापनकर्ता<br>
                           <img src="{{ asset($fso->signature) }}" alt="client" width="70" height="70" class="shadow-sm mr-3"/>
                           <br>
                           {{$fso->name}}
                           <br>
                           Approved Date / स्वीकृति दिनांक <br> {{$applicationDetail->updated_at }}
                        ...
                        <td style="text-align:center;font-size:14px;width:40%;">Approver (issuing authority)/अनुमोदनकर्ता (जारीकर्ता अधिकारी)<br>
