...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Manage Deputy Director</h5>
    </div>
    <div class="d-flex app-header-btn">
        ...
        <div>
            ...
            <a href="<?php echo route('admin.deptydirectoradd');?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-plus me-1"></i> Add New Deputy Director
            </a>
        </div>
    </div>
</div>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <form action="{{ route('admin.deputyfilter') }}" method="GET" class="advanced-search br-3">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-lg-0">
                                    ...
                                    <input type="text" class="form-control" name="filter_email"
                                        value="{{ request('filter_email') }}" id="filter_email"
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-lg-0">
                                    <label>Phone :</label>
                                    <input type="text" class="form-control" name="phone" value="{{ request('phone') }}" id="district_name"
                ...
                <div class="table-responsive">
                    ...
                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                        ...
                        <tbody>
                            ...
                            @foreach ($DeputyData as $index => $district)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $district ->name}}</td>
                                ...
                                <td class="text-right">
                                    <a href="{{ route('admin.editdeptydirector', $district->id) }}"
                                        class="btn btn-primary btn-sm">Edit</a>

                                    <form action="{{ route('admin.deletedeptydirector', $district->id) }}" method="POST"
