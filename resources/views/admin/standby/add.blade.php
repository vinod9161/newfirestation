        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="table-responsive---">
                    <div class="col-md-12 standbytoaster"></div>
                    <div class="col-md-12 standbyaddFsoFormDiv">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="program_type" id="program_type" class="form-control js-example-basic-single">
                                            ...
                                            <option value="vip/vvip duty">Vip/Vvip duty</option>
                                              <option value="Fair/festival/exhibition duty">Fair/festival/exhibition duty</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="program_datetime" id="program_datetime" class="form-control" placeholder="Enter Type">
    ...
    $(document).on('submit','#standbyForm',function(e) {
     ...
     $(document).on('submit', '#OtpPostverify', function(e) {
        ...
        if (otpinput0 == '' || otpinput1 == '' || otpinput2 == '' || otpinput3 == '' || otpinput4 ==
            ...
            $.ajax({
                url: "{{ route('admin.standByOtpPost') }}",
                method: "POST",
                data: {
                    otpValue: otpValue,
                    otpMobile: otpMobile,
