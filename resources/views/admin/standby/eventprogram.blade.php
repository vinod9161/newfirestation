...
@section('title')
<title>Stand By Duty Program | Admin Dashboard</title>
@endsection
@section('style')
<style>
    input:read-only {
...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
   <div>
      <h5 class="main-content-title text-default fs-24 mg-b-4 mb-0">Manage Stand By Duty Program Requests</h5>
   </div>
   <div class="d-flex app-header-btn">
      <div>
         <a href="<?php echo route('admin.standby'); ?>" class="btn ripple btn-wave btn-success mb-0">
            <i class="fe fe-plus me-1"></i> View Stand By Duty Program
         </a>
      </div>
   </div>
</div>
      ...
      <div class="card custom-card">
         ...
         <div class="card-body">
            <div class="table-responsive">
               ...
               <form method="post" action="{{ route('admin.standByEventProgramData') }}" id="eventPrograme" enctype="multipart/form-data">
                @csrf
                    <div class="row">
