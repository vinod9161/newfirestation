                ...
                <div class="table-responsive---">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.updatehydrant') }}" method="post">
                                        @csrf
                                        <div class="row">
                                                    ...
                                                    <select name="firestation" id="firestation" class="form-control js-example-basic-single">
                                                        <option value="">--- Select Station फायर स्टेशन ---</option>
                                                            @if ($getfirestation)
                                                                ...
                                                                @endforeach
                                                            @else
                                                               <option value="" class="text-danger"> No Firestation Available</option> 
                                                            @endif
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="water_source" id="water_source" class="form-control" placeholder="Enter Address of Water Sources" value="{{ $getData->address_of_water_sources }}">
                                                        ...
                                                        <option value="">--Select Type--</option>
                                                         @if ($getType)
                                                            @foreach ($getType as $key => $row)
                                                                @if($row->id == $getData->type)
                                                                    <option value="{{ $row->id }}" selected>{{ $row->hydrant_type }}</option>
                                                                @else
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lat" id="lat" class="form-control" placeholder="Enter Latitude" value="{{ $getData->latitude }}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="long" id="long" class="form-control" placeholder="Enter Longitude" value="{{ $getData->longitude }}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select form-control" name="hydrant_condtion" id="hydrant_condtion">
                                                        <option value="">--Select Condition--</option>
                                                        @if ($getCondition)
                                                            @foreach ($getCondition as $key => $row)
                                                                @if($row->id == $getData->hydrant_condition)
                                                                    <option value="{{ $row->id }}" selected>{{ $row->hydrant_condition }}</option>
                                                                @else
                                            ...
                                            <div class="col-md-12">
                                                <input type="hidden" name="hid" id="hid" value="{{ $getData->id }}">
                                                <button type="submit" id="addHydrant" class="btn btn-primary btn-sm" style="width:20%">Update</button>
                                            </div>
                                        </div>
                                    </form>    
                                </div>
