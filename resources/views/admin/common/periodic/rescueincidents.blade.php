...
@section('title')
<title>Periodic Rescue Incidents</title>
@endsection
@section('style')
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                           <div class="btn-list"> 
                            ...
                            <a href="{{ route('admin.periodic-report-rescue-incidents') }}" type="button" class="btn btn-primary btn-wave waves-effect waves-light">Rescue Incident</a>
                ...
                <div class="col-md-12" style="margin-top:2em;">
                    <h4 class="text-center alert alert-primary">Details of Resuce Incidents</h4>
                    <hr>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="table-responsive">
                        <table class="table ucp-table table-hover table-bordered display" id="rescue-table" cellspacing="0" width="100%">
                            <tbody><tr style="height:36pt">
                               ...
                               <th style="width:73pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt" rowspan="2">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;line-height: 14pt;">Name of</p>
                               </th>
                               <!-- <th style="width:85pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt" rowspan="2">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;line-height: 14pt;">Type Of rescue</p>
                                  </th> -->
                               <th style="width:53pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt" rowspan="2">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 10pt;text-indent: 0pt;">Total Rescue incident</p>
                               </th>
                               <th style="width:88pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt" colspan="2">
                                  <p class="s5" style="padding-left: 14pt;text-indent: 0pt;line-height: 14pt;">Lives saved</p>
                               </th>
