...
@section('title')
<title>Periodic Awareness Program</title>
@endsection
@section('style')
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                           <div class="btn-list"> 
                            ...
                            <a href="{{ route('admin.periodic-report-awareness-programs') }}" type="button" class="btn btn-primary btn-wave waves-effect waves-light">Awareness Programe</a>
                ...
                <div class="col-md-12" style="margin-top:2em;">
                    <h4 class="text-center alert alert-primary">Details of Fire Service Awareness Programe</h4>
                    <hr>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
