...
@section('title')
<title>Periodic Service Duties</title>
@endsection
@section('style')
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                           <div class="btn-list"> 
                            ...
                            <a href="{{ route('admin.periodic-report-service-duties') }}" type="button" class="btn btn-primary btn-wave waves-effect waves-light">Service Duties</a>
                ...
                <div class="col-md-12" style="margin-top:2em;">
                    <h4 class="text-center alert alert-primary">Details of Fire Service Duties</h4>
                    <hr>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="table-responsive">
                        <table class="table ucp-table table-hover table-bordered display" id="duties-table" cellspacing="0" width="100%">
                            <tbody><tr style="height:52pt">
                               ...
                               <th style="width:82pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                               ...
                               <th style="width:73pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;">Name of</p>
                               </th>
                               <th style="width:85pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 11pt;text-indent: 0pt;text-align: justify;">Type Of duty</p>
                               </th>
                               <th style="width:69pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;">Total No</p>
                               </th>
                               ...
                               <td style="width:85pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p style="text-indent: 0pt;text-align: left;">mock drill<br></p>
                               </td>
                               ...
                               <td style="width:85pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p style="text-indent: 0pt;text-align: left;">vip/vvip duty<br></p>
                               </td>
                               <td style="width:69pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p style="text-indent: 0pt;text-align: left;">3 <br></p>
                               </td>
