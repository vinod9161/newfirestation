        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                           <div class="btn-list"> 
                            ...
                            <a href="{{ route('admin.periodic-report-noc') }}" type="button" class="btn btn-primary btn-wave waves-effect waves-light">Fire NOC</a>
                ...
                <div class="col-md-12" style="margin-top:2em;">
                    <h4 class="text-center alert alert-primary">Details of Fire NOC</h4>
                    <hr>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="table-responsive">
                        <table class="table ucp-table table-hover table-bordered display" id="noc-table" cellspacing="0" width="100%">
                            <tbody><tr style="height:57pt">
                               ...
                               <th style="width:62pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 5pt;padding-right: 12pt;text-indent: 0pt;">Name of District</p>
                               </th>
                               <th style="width:62pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 12pt;text-indent: 0pt;">Name of fire station</p>
                               </th>
                               <th style="width:90pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;line-height: 14pt;">Type Of NOC/Clearance</p>
                               </th>
                               <th style="width:59pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 10pt;text-indent: 0pt;">Pending in the month</p>
                               </th>
                               <th style="width:60pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 5pt;padding-right: 6pt;text-indent: 0pt;">Received in Month</p>
                               </th>
                               <th style="width:48pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 5pt;text-indent: 0pt;">Total</p>
                               </th>
                               <th style="width:58pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 5pt;padding-right: 3pt;text-indent: 0pt;">Disposed In Month</p>
                               </th>
                               <th style="width:66pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;">Remaining</p>
                               </th>
                               <th style="width:47pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                            ...
                            <tr style="height:16pt">
                               ...
                               <td style="width:66pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p style="text-indent: 0pt;text-align: left;"><br></p>
                               </td>
