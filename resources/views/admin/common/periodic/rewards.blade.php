        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                           <div class="btn-list"> 
                                ...
                                <a href="{{ route('admin.periodic-report-rewards') }}" type="button" class="btn btn-primary btn-wave waves-effect waves-light">Rewards</a>
                ...
                <div class="col-md-12" style="margin-top:2em;">
                    <h4 class="text-center alert alert-primary">Details of Rewards</h4>
                    <hr>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="table-responsive">
                        <table class="table ucp-table table-hover table-bordered display" id="rewards-table" cellspacing="0" width="100%">
                            <tbody><tr style="height:86pt">
                               ...
                               <th style="width:66pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;">Who given the Reward</p>
                               </th>
                               <th style="width:58pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 5pt;text-indent: 0pt;">Name of recipient</p>
                               </th>
                               <th style="width:63pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 19pt;text-indent: 0pt;">Date of reward</p>
                               </th>
                               <th style="width:125pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 5pt;text-indent: 0pt;">Type Of Reward</p>
                               </th>
                               <th style="width:113pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;">Other comments</p>
                               </th>
                            </tr>
