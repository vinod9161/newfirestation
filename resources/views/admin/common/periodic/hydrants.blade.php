        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                           <div class="btn-list"> 
                            ...
                            <a href="{{ route('admin.periodic-report-hydrants') }}" type="button" class="btn btn-primary btn-wave waves-effect waves-light">Hydrants/Water Outlets & Bodies</a>
                ...
                <div class="col-md-12" style="margin-top:2em;">
                    <h4 class="text-center alert alert-primary">Details of Fire Hydrants/Water Outlets/Other Water Bodies</h4>
                    <hr>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="table-responsive">
                        <table class="table ucp-table table-hover table-bordered display" id="hydrants-table" cellspacing="0" width="100%">
                            <tbody><tr style="height:56pt">
                               ...
                               <th style="width:68pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 5pt;padding-right: 18pt;text-indent: 0pt;">Name of District</p>
                               </th>
                               <th style="width:69pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;line-height: 14pt;">Name of fire station</p>
                               </th>
                               <th style="width:99pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 20pt;text-indent: 0pt;">Type Of water outlets</p>
                               </th>
                               <th style="width:68pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;line-height: 14pt;">Total No</p>
                               </th>
                               <th style="width:65pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 14pt;text-indent: 0pt;">Working Nos</p>
                               </th>
                               <th style="width:68pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;text-indent: 0pt;line-height: 14pt;">Non Working Nos</p>
                               </th>
                               <th style="width:60pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p class="s5" style="padding-left: 4pt;padding-right: 4pt;text-indent: 0pt;">Proposed Nos</p>
                               </th>
                               <th style="width:55pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                            ...
                            <tr style="height:17pt">
                               ...
                               <td style="width:99pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p style="text-indent: 0pt;text-align: left;"><br></p>
                               </td>
                               <td style="width:68pt;border-top-style:solid;border-top-width:2pt;border-left-style:solid;border-left-width:2pt;border-bottom-style:solid;border-bottom-width:2pt;border-right-style:solid;border-right-width:2pt">
                                  <p style="text-indent: 0pt;text-align: left;"><br></p>
