...
@section('title')
<title>User Profile Settings | Admin Dashboard</title>
@endsection
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    @if($user->signature)
                                        <img src="{{ asset($user->signature) }}" alt="Signature" class="img-fluid" style="width:100%; height:45px; object-fit:fill;">
                                    @else
                                        <div>Signature not uploaded</div>
                                    @endif
                                </div>
                                ...
                                @if($isEditable)
                                    ...
                                    <div class="col-md-3 form-group" style="margin-top:28px">
                                        <button type="submit" class="btn btn-primary w-100" id="update_profile">Update</button>
                                    </div>
                                @endif
