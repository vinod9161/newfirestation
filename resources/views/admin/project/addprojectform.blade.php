...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Manage Category / Project</h5>
    </div>
    <div class="d-flex app-header-btn">
        
        <div>
            <a href="<?php echo route('admin.projects');?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-eye me-1"></i> View Project List
            </a>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive---">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.saveproject') }}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group" style="margin-top:32px;">
                                                    <label>&nbsp;</label>
                                                    <button type="submit" id="addProject" class="btn btn-primary btn-sm" style="width:40%">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>    
