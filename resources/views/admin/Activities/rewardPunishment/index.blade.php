...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Manage Reward/ Punishment</h5>
    </div>
    <div class="d-flex app-header-btn">

        <div>
            <a href="<?php echo route('admin.addRewardPanishment'); ?>"
                class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-plus me-1"></i> Add Reward/ Punishment
            </a>
        </div>
    </div>
</div>
                    ...
                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr class="my-job-item">
                                ...
                                <td>{{$ins->activity}}</td>
                                <td>{{$ins->reward_type}}</td>
                                <td>{{$ins->awarded_by}}</td>
                                <td>{{$ins->recipient}}</td>
                                <td>{{date('d-M-Y', strtotime($ins->date))}}</td>
                                <td class="d-none d-md-table-cell text-right">
                                    <a href="{{route('admin.viewRewardPanishment', $ins->id)}}"
