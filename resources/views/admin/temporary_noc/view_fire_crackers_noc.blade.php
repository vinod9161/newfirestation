                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                <tbody>
                                                    <tr>
                                                        <td>From Date</td>
                                                        <td> {{ $project_area_detail->from_date }} </td>
                                                        <td>To Date</td>
                                                        <td> {{ $project_area_detail->to_date }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Capacity</td>
                                                        <td> {{ $project_area_detail->capacity }} </td>
                                                        <td>Distance from nearest petrol pump</td>
                                                        <td> {{ $project_area_detail->distance_from_nearest_petrol_pump }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Distance from nearest shop building</td>
                                                        <td> {{ $project_area_detail->shop_building }} </td>
                                                        <td>Name of item</td>
                                                        <td> {{ $project_area_detail->name_of_item }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Other Detail</td>
                                                        <td> {{ $project_area_detail->other_detail }} </td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                </tbody>
