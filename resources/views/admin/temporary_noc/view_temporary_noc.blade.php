                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered table-striped table-hover mt-2">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Pincode</td>
                                                        <td>{{ $organizingAddress->pincode ?? 'NA' }}</td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                    @endif
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{ $project_area_detail->total_plot_area }} </td>
                                                    <td>Unit</td>
                                                    <td> {{ $project_area_detail->plot_area_unit }} </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{ $project_area_detail->function_type }} </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{ $project_area_detail->no_camps }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Number of Stalls</td>
                                                    <td> {{ $project_area_detail->no_stalls }} </td>
                                                    <td>Provision of Kitchen/Food stall</td>
                                                    <td> {{ ucfirst($project_area_detail->pro_kitchen) }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Boundary</td>
                                                    <td> {{ ucfirst($project_area_detail->boundary) }} </td>
                                                    <td>Use of Inflammable item</td>
                                                    <td> {{ ucfirst($project_area_detail->inflammable) }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Type of Inflammable item</td>
                                                    <td> {{ $project_area_detail->inflamable_type }} </td>
                                                    <td>Whether the activity is Open or indoor</td>
                                                    <td> {{ ucfirst($project_area_detail->open_indoor) }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Seating Capacity of Stage</td>
                                                    <td> {{ $project_area_detail->seating_capacity }} </td>
                                                    <td>Number of fire/Security Person</td>
                                                    <td> {{ $project_area_detail->security_person }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Width of Approach Road (in Meter)</td>
                                                    <td> {{ $project_area_detail->road_width }} </td>
                                                    <td>Separate Parking Area</td>
                                                    <td> {{ ucfirst($project_area_detail->parking) }} </td>
                                                </tr>
                                                <tr>
                                                    <td>No. of Entrance</td>
                                                    <td> {{ $project_area_detail->no_entrance }} </td>
                                                    <td>Height of Entrance(in Meter)</td>
                                                    <td> {{ $project_area_detail->entrance_height }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Width of Entrance(in Meter)</td>
                                                    <td> {{ $project_area_detail->entrance_width }} </td>
                                                    <td>No. of Exit</td>
                                                    <td> {{ $project_area_detail->no_exit }} </td>
                                                </tr>
                                                <tr>
                                                    <td>Height of Exit(in Meter)</td>
                                                    <td> {{ $project_area_detail->exit_height }} </td>
                                                    <td>Width of Exit(in Meter)</td>
                                                    <td> {{ $project_area_detail->exit_width }} </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                <tbody>
                                                    ...
                                                    @endif
                                                    @if(isset($attachments->route_plan))
                                                    <tr>
                                                        <td colspan="2">If Yatra is organizing attached the route plan and No. of Person Participate in Yatra</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Reference Letter</td>
                                                        <td><a href="{{ asset($attachments->route_plan)}}" target="blank" title="View Reference Letter"><i class="fa fa-download"></i></td>
                                                    </tr>
                                                    @endif
