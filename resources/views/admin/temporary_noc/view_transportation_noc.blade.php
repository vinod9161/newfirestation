                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td> {{ $project_area_detail->mode_of_transport }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Means of Transport (Vehicle)- Type and Details</td>
                                                        <td> {{ $project_area_detail->means_of_transport }} </td>
                                                        <td>Number of Transport Vehicle for Hazardous Material</td>
                                                        <td> {{ $project_area_detail->no_of_transport }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Name of Hazardous Material</td>
                                                        <td> {{ $project_area_detail->name_of_hazardous_material }} </td>
                                                        <td>Category/Class of Hazardous Material</td>
                                                        <td> {{ $project_area_detail->category_of_hazardous_material }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Capacity of Transported Hazardous Material</td>
                                                        <td> {{ $project_area_detail->capacity_of_hazardous_material }} </td>
                                                        <td>Number of Person including in Transportation</td>
                                                        <td> {{ $project_area_detail->no_of_person }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Expected Date of Transportation</td>
                                                        <td> {{ $project_area_detail->expected_date }} </td>
                                                        <td>Expected Time of Transportation</td>
                                                        <td> {{ ucfirst($project_area_detail->expected_time) }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Route of Transportation example: A to D via B,C,etc</td>
                                                        <td> {{ ucfirst($project_area_detail->route_transportation) }} </td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                </tbody>
