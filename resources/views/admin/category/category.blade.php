...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    <div class="d-flex app-header-btn">
        ...
        <div>
            <a href="<?php echo route('admin.addcategory');?>" class="btn ripple btn-wave  btn-success mb-0">
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <form action="{{ route('admin.categoryfilter') }}" method="GET" class="advanced-search br-3">
            <div class="advanced-search br-3">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group mb-lg-0">
                                    ...
                                    <input type="text" class="form-control" name="filter_category"
                                        value="{{ request('filter_category') }}" id="filter_name"
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-lg-0">
                                    ...
                                    <input type="text" class="form-control" name="filter_projects"
                                        value="{{ request('filter_projects') }}" id="filter_projects"
                ...
                <div class="text-end">
                    ...
                    <a href="{{ route('admin.category') }}" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
    </div>
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
                                    ...
                                    Category<div style="height: 25px;"></div>
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
