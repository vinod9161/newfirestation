...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    <div class="d-flex app-header-btn">
        ...
        <div>
            <a href="<?php echo route('admin.addsubcategory');?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-plus me-1"></i> Add New Sub Category
            </a>
        </div>
    </div>
</div>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <form action="{{ route('admin.subcategoryfilter') }}" method="GET" class="advanced-search br-3">
            <div class="advanced-search br-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-lg-0">
                                    ...
                                    <input type="text" class="form-control" name="filter_category"
                                        value="{{ request('filter_category') }}" id="filter_category"
                ...
                <div class="text-end">
                    ...
                    <a href="{{ route('admin.subcategory') }}" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
    </div>
                ...
                <div class="table-responsive">
                    ...
                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
                                    ...
                                    Sub Category<div style="height: 25px;"></div>
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="employee-table" rowspan="1" colspan="1"
                                    aria-label="Name: activate to sort column ascending" style="width: 153px;">Category
                        ...
                        <tbody>
                            ...
                            @foreach ($getSubcategory as $index => $category)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $category->name }}</td>
                                ...
                                <td class="text-right">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.editsubcategory', $category->id) }}"
                                        class="btn btn-primary btn-sm"><i class="fe fe-eye"></i></a>
                                    <!-- Delete Button -->
                                    <a href="{{ route('admin.deletesubcategory', $category->id) }}"
                                        class="btn btn-danger btn-sm"
                                        onclick="return confirm('Are you sure you want to delete this sub category?');"><i
