...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    <div>
        <h5 class="main-content-title text-default  fs-24  mg-b-4 mb-0">Manage Category / Type</h5>
    </div>
                ...
                <div class="table-responsive---">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-8" style="margin:0 auto;">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.savetype') }}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" id="addType" class="btn btn-primary btn-sm" style="width:20%">Submit</button>
                                            </div>
                                        </div>
                                    </form>    
                                </div>
    ...
    $.ajax({
        ...
        success: function(resp) 
        {
            ...
            if ($('#subcategory').data('select2')) {
                $('#subcategory').select2().val(null).trigger('change'); // Reset and refresh
            } 
            else {
                $('#subcategory').val(null); // If not using a plugin, just reset the value
            }
        }
    });
});
