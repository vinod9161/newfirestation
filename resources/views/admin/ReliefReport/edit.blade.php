    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="post" enctype="multipart/form-data" action="{{ route('admin.updateReliefReport') }}">
                    @csrf
                    <div class="divborder">
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="relief_report_no" id="relief_report_no" type="number" value="{{ $reliefReport[0]->relief_report_no }}"/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="monthly_no" id="monthly_no" type="number" value="{{ $reliefReport[0]->monthly_no }}"/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="incident_datetime" id="incident_datetime" type="datetime-local" value="{{ $reliefReport[0]->incident_datetime }}"/>
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="225" name="informer_name" id="informer_name" type="text" value="{{ $reliefReport[0]->informer_name }}"/>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="informer_contact_no" id="informer_contact_no" type="number" value="{{ $reliefReport[0]->informer_contact_no }}"/>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="info_medium" id="info_medium" type="text" value="{{ $reliefReport[0]->info_medium }}"/>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="info_datetime" id="info_datetime" type="datetime-local" value="{{ $reliefReport[0]->info_datetime }}"/>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" maxlength="512" name="incident_address" id="incident_address" style="height:50px;" required>{{ $reliefReport[0]->incident_address }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="incident_longitude" id="incident_longitude" value="{{ $reliefReport[0]->longitude }}">           
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="incident_latitude" id="incident_latitude" value="{{ $reliefReport[0]->latitude }}">     
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="station_depart_datetime" id="station_depart_datetime" type="datetime-local" value="{{ $reliefReport[0]->station_depart_datetime }}" />     
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="site_arrive_datetime" id="site_arrive_datetime" type="datetime-local" value="{{ $reliefReport[0]->site_arrive_datetime }}" />     
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="station_return_datetime" id="station_return_datetime" type="datetime-local" value="{{ $reliefReport[0]->station_return_datetime }}" />     
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="distance" id="distance" type="number" step="any" pattern="^\d*(\.\d{0,3})?$" value="{{ $reliefReport[0]->distance }}" />     
                    ...
                    <div class="divborder">
                        ...
                        @php 
                            $vehicle = json_decode($reliefReport[0]->vehicle_id); 
                            $pumping = json_decode($reliefReport[0]->pumping_km);
                        @endphp
                        ...
                        <div class="row"  id="row{{$v}}" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="vehicle_id[]" id="vehicle_id" required>
                                        ...
                                        <option {{ $vehicle[$v] == $veh['id'] ? 'selected' : '' }} value="{{ ucfirst($veh['id']) }}">{{ ucfirst($veh['reg_number']) }}, {{ ucfirst($veh['vehicle_type']) }} </option>
                                        @endforeach
                                    </select>     
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="255" name="pumping_km[]" id="pumping_km" type="number" placeholder="Pumping in KM" value="{{ $pumping[$v] }}">     
                    ...
                    <div class="divborder">
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            ...
                            @php 
                                $cfoArray = explode(',',$reliefReport[0]->cfo); 
                                $fsoArray = explode(',',$reliefReport[0]->fso);
                                $fssoArray = explode(',',$reliefReport[0]->fsso);
                                $lfmArray = explode(',',$reliefReport[0]->lfm);
                                $dvrArray = explode(',',$reliefReport[0]->dvr);
                                $fmArray = explode(',',$reliefReport[0]->fm);
                            @endphp
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>CFO</label>
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="60" maxlength="225" name="owner_name" id="owner_name" type="text" value="{{ $reliefReport[0]->owner_name }}" />     
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="relief_work_area" id="relief_work_area">
                                        <option {{ $reliefReport[0]->relief_work_area == 1 ? 'selected' : '' }} value="1">Rural ग्रामीण</option>
                                        <option {{ $reliefReport[0]->relief_work_area == 2 ? 'selected' : '' }} value="2">City शहरी</option>
                                    </select>    
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="relief_work_type" id="relief_work_type">
                                        <option {{ $reliefReport[0]->relief_work_type == 1 ? 'selected' : '' }} value="1">Disaster Dewatering आपदा में पानी निकलना</option>
                                        <option {{ $reliefReport[0]->relief_work_type == 2 ? 'selected' : '' }} value="2">Removing Fallen tree गिरे पेड़ो को हटाना</option>
                                        <option {{ $reliefReport[0]->relief_work_type == 3 ? 'selected' : '' }} value="3">Clear the passage पेड़ो को हटाकर रास्ता सुचारू करना</option>
                                        <option {{ $reliefReport[0]->relief_work_type == 4 ? 'selected' : '' }} value="4">Distribution of relief goods राहत सामग्री का वितरण</option>
                                        <option {{ $reliefReport[0]->relief_work_type == 5 ? 'selected' : '' }} value="5">Organising a public kitchen आम जनता हेतु भोजन प्रबन्धन</option>
                                        <option {{ $reliefReport[0]->relief_work_type == 6 ? 'selected' : '' }} value="6">Distribution of medicine आवश्यक दवाइयों का वितरण</option>
                                        <option {{ $reliefReport[0]->relief_work_type == 7 ? 'selected' : '' }} value="7">Counseling of victims घायलों की काउंसलिंग </option>
                                        <option {{ $reliefReport[0]->relief_work_type == 8 ? 'selected' : '' }} value="8">Safely evacuation of people from denger zone जोन में लोगों को सुरक्षित पार कराना</option>
                                        <option {{ $reliefReport[0]->relief_work_type == 9 ? 'selected' : '' }} value="9">Other अन्य</option>
                                    </select>    
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" maxlength="512" name="owner_address" id="owner_address" style="height:50px;">{{ $reliefReport[0]->owner_address }}</textarea>    
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" maxlength="1000" name="relief_work_reason" id="relief_work_reason" style="height:50px;"> {{ $reliefReport[0]->relief_work_reason }}</textarea>    
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" maxlength="1000" name="description" id="description" style="height:50px;">{{ $reliefReport[0]->description }}</textarea>    
                        ...
                        <div class="row" style="padding-left: 10px;padding-right: 10px;">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="ytupload" type="hidden" value="" name="upload" value="{{ $reliefReport[0]->upload }}" />
                    ...
                    <div class="row">
                        <div class="col-md-12" align="center">
                            <input type="hidden" name="id" id="id" value="{{ $reliefReport[0]->id }}">
