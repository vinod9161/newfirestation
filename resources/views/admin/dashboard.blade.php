    ...
    <div class="col-md-12">
        <div class="card custom-card">
            <div class="card-header">
                <a href="{{ route('admin.dashboardtwo') }}" class="btn btn-primary btn-sm" style="float: right">Dashboard 2</a>
            </div>
                    ...
                    <div class="col-md-12" style="overflow-x: scroll;">
                        <div class="card-container">
                            <div class="kpi-card">
                                ...
                                <div class="value" id="total_fire_station"><?= number_format($fire_station_count)??0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Total<br>Manpower</h4>
                                <div class="value" id="total_man_power"><?=  number_format($man_power_count)??0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Total<br>Vehicles</h4>
                                <div class="value" id="total_vehicles"><?=  number_format($vehicles_count)??0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Total<br>Equipment</h4>
                                <div class="value" id="total_equipment"><?=  number_format($equipment_count)??0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Total Fire<br>Calls</h4>
                                <div class="value"><?php  echo number_format($fire_Calls_Count) ?? 0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Rescue & Relief<br>Calls</h4>
                                <div class="value" total_rescue><?= number_format($totalReliefRescueCount)??0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Saved Lives<br>(persons)</h4>
                                <div class="value" id="save_life"><?= number_format($save_life_count) ?? 0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Saved<br>Property</h4>
                                <div class="value" id="save_property"><?= number_format($save_property_count) ?? 0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>NOCs Issued<br>(count)</h4>
                                <div class="value" id="total_noc"><?= number_format($noc_count) ?? 0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Awareness<br>Programs</h4>
                                <div class="value" id="total_w_p"><?= number_format($awareness_program_count) ?? 0 ?></div>
                            </div>

                            <div class="kpi-card">
                                <h4>Operational<br>Duties</h4>
                                <div class="value"><?= number_format($op_duty_count) ?? 0 ?></div>
                            </div>
        ...
        <div class="card custom-card">
            <div class="card-body dash1">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <canvas id="PendingApplicationMyStackedBarChart" height="180"></canvas>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body dash1">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <canvas id="AwarenesProgramBarChart" height="448"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6 form-group">
        <div class="card custom-card">
            <div class="card-body dash1">
                <div class="row">
                    <div class="col-md-12">
                        <canvas id="VehicleCompositionBarChart" height="170"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6 form-group">
        <div class="card custom-card">
            <div class="card-body dash1">
                <div class="row">
                    <div class="col-md-12">
                        <canvas id="emergencyChart" height="325"></canvas>
                    </div>
                </div>
            </div>
        </div>
		...
		new Chart(ctxVehicle, {
			...
			options: {
				...
				plugins: {
					...
					title: {
						display: true,
						text: 'Vehicle Composition', // Your chart title
						font: {
							size: 16,
							weight: 'bold'
						}
