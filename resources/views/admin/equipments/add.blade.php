        ...
        <div class="card custom-card">
            ...
            @endif
                ...
                <div class="table-responsive">
                    <form id="equipmentForm" action="{{ route('admin.saveequipment') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" name="total_equipemnt" id="total_equipemnt" class="form-control numeric-only" placeholder="Enter Total Equipments">
                            </div>

                            <div class="col-md-3 form-group">
                                <label>Total Working Equipments <sup class="text-danger">*</sup></label>
                                <input type="text" name="total_working_equipemnt" id="total_working_equipemnt" class="form-control numeric-only" placeholder="Enter Total Working Equipments">
                            </div>

                            <div class="col-md-3 form-group">
                                <label>Total Non-Working Equipment <sup class="text-danger">*</sup></label>
                                <input type="text" name="total_non_working_equipemnt" id="total_non_working_equipemnt" class="form-control numeric-only" placeholder="Enter Total Non-Working Equipments">
                            </div>
