                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="employee_code" id="employee_code"
                                                        class="form-control" placeholder="Enter Employee Code" required>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control js-searchBox" name="gender" id="gender"
                                                        required>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" size="60" maxlength="100"
                                                        ...
                                                        placeholder="Name In Hindi नाम हिंदी में" required />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="entry_level" id="entry_level"
                                                        ...
                                                        <option value="Fire station second officer">Fire station secondofficer</option>
                                                        <option value="Fireman">Fireman</option>
                                                        <option value="Ministerial">Ministerial</option>
                                                        <option value="Cook/kahar">Cook/kahar</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="designation" id="designation"
                                                        ...
                                                        <option value="Chief fire officer">Chief fire officer</option>
                                                        <option value="Fire station officer">Fire Station Officer
                                                        </option>
                                                        <option value="Fire station second officer">Fire station second
                                                            officer</option>
                                                        <option value="Leading fireman">Leading Fireman</option>
                                                        <option value="Fire service driver">Fire Service Driver</option>
                                                        <option value="Fireman">Fireman</option>
                                                        <option value="Assistant sub inspector(M)">Assistant sub
                                                            inspector(M)</option>
                                                        <option value="Cook/kahar">Cook/kahar</option>
                                                        <option value="Peon">Peon</option>
                                                        <option value="Sweper">Sweper</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" size="50" maxlength="50"
                                                        ...
                                                        placeholder="Date Of Recuirtment" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Date Of Retirement सेवानिवृत्ति तिथि <sup
                                                            class="text-danger">*</sup></label>
                                                    <input class="form-control" size="50" maxlength="50"
                                                        name="date_of_retirement" id="date_of_retirement" type="text"
                                                        placeholder="Date Of Retirement" readonly />
...
function handler(e)
{
    ...
    var formattedDate = ("0" + retirement_date.getDate()).slice(-2) + '/' + 
