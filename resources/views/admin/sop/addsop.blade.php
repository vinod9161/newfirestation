                    ...
                    <div class="col-md-7" style="margin:0 auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.sop.post') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Subject<sup class="text-danger">*</sup></label>
                                                <input type="text" name="subject" id="subject" class="form-control" required placeholder="Enter SOP Subject">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Upload SOP<sup class="text-danger">*</sup></label>
                                                <input type="file" name="file" id="file" class="form-control" required placeholder="Select SOP File">
...
<script>
    $(document).ready(function(){
        $('#addsop').on('click', function(){
            ...
            {
                $('#fileErr').html('Required SOP File For Upload').delay(3000).fadeOut().css('display','block');
                return false;  
            }
