...
<div class="d-md-flex d-block align-items-center justify-content-between my-4">
    ...
    <div class="d-flex app-header-btn">
        ...
        <div>
            <a href="<?php echo route('admin.add-sop');?>" class="btn ripple btn-wave  btn-success mb-0">
                <i class="fe fe-plus me-1"></i> Add SOP
            </a>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                        <thead>
                            ...
                            <?php $sn=1; if(!empty($getSop)):?>
                            <?php foreach($getSop as $key => $val):?>
                                <tr>
                                    <td>{{ $sn; }}</td>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <a href="{{'/'.$val->upload_sop}}" class="btn btn-primary btn-sm" download><i class="fa fa-cloud-download"></i> Download</a>
                                        @endif
                                    </td>
                                    ...
                                    @if (Auth::user()->type == '0' || Auth::user()->type == '1' || Auth::user()->type == '4')
                                        <td> 
                                            <a href="{{ route('admin.sop.edit', $val->id) }}" class="btn btn-success  btn-sm" title="Edit SOP"><i class="fe fe-edit"></i></a>
                                            <a  onclick="return confirm('Are you sure you want to delete this?')" 
                                                    href="{{ route('admin.sop.delete', $val->id) }}" 
